...
UPDATE `creature` SET `wander_distance` = 0, `movement_type` = 0 WHERE `guid` IN (257914, 257907);

UPDATE `creature_template` SET `InhabitType` = 4 WHERE `entry` = 39677;
UPDATE `waypoint_data` SET `move_flag` = 1 WHERE `id` IN (257440, 257441, 258033, 258046, 258218);
