...
DELETE FROM `command` WHERE `name` IN ("reload locales_creature", "reload locales_gossip_menu_option", "reload locales_item", "reload creature_template_locale", "reload gossip_menu_option_locale", "reload item_template_locale");
