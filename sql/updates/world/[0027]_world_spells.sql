...
DELETE FROM `spell_script_names` WHERE `spell_id` IN (42254, 42255, 42256, 42257, 42258, 42259, 42260, 42261, 42263, 42264, 43959, 43961,
                                                      51694, 49738, 49822, 50098, 49864, 49962, 69041);
