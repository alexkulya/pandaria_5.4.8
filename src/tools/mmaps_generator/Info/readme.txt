...
--skipContinents    [true|false]    continents are maps 0 (Eastern Kingdoms),
                                    ...
                                    369 (Deeprun Tram), 449 (Alliance PVP Barracks), 450 (Horde PVP Barracks), 609 (Ebon Hold)
...
--skipBattlegrounds [true|false]    does not include PVP arenas
                                    ...
                                    false: build battlegrounds (default)

--skipArenas        [true|false]    build PVP arenas

                                    false: build battlegrounds (default)

--skipDungeons      [true|false]    build dungeon and raid maps

                                    false: build dungeon and raid maps (default)

--skipTransports    [true|false]    build transport maps

                                    false: build transport maps (default)
