...
public:
    ...
    struct instance_blackrock_depths_InstanceMapScript : public InstanceScript
    {
        ...
        {
            TC_LOG_DEBUG("server", "Instance Blackrock Depths: SetData64 update (Type: %u Data " UI64FMTD ")", type, data);
        ...
        {
            TC_LOG_DEBUG("server", "Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
