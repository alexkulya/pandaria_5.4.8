...
void AddSC_boss_megaera()
{
    ...
    register_creature_script(npc_cinders_megaera);
    register_creature_script(npc_nether_tear_spawner);
    register_creature_script(npc_icy_ground_megaera);
    register_creature_script(npc_torrent_of_ice);
    register_creature_script(npc_nether_wyrm_megaera);
    register_creature_script(npc_megaera_back_head_spawner);

    register_aura_script(spell_concealing_fog_megaera);
    register_spell_script(spell_cinders_megaera);
    register_aura_script(spell_cinders_megaera_aura);
    register_aura_script(spell_arctic_freeze_megaera);
    new spell_acid_glob_megaera();
    register_spell_script(spell_icy_ground_dummy);
    register_aura_script(spell_megaera_submerged);
    register_spell_script(spell_acid_rain_summon);
    register_spell_script(spell_acid_rain_missile);
    register_spell_script(spell_acid_rain_damage);
    register_aura_script(spell_megaera_hydra_frenzy);
    register_aura_script(spell_megaera_rampage);
    register_aura_script(spell_nether_tear);
    register_aura_script(spell_diffusion_proc);
    register_spell_script(spell_torrent_of_ice_summon);
