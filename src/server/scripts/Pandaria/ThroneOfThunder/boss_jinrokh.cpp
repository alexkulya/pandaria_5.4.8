...
{
    new boss_jinrokh();
    register_creature_script(npc_focused_lightning);
    register_creature_script(npc_lightning_fissure);
    new npc_jinrokh_statue();
    new npc_conductive_water();
    new npc_lightning_storm_bunny();
    register_creature_script(npc_lightning_strike_charges);

    register_spell_script(spell_focused_lightning_targeting);
    register_spell_script(spell_focused_lightning_aoe);
    register_spell_script(spell_focused_lightning_detonation);
    register_spell_script(spell_implosion);
    register_aura_script(spell_static_wound);
    register_spell_script(spell_static_wound_damage);
    register_aura_script(spell_static_burst);
    register_aura_script(spell_lightning_storm_visual);
    register_aura_script(spell_lightning_storm);
    register_spell_script(spell_thundering_throw_silence);
    register_spell_script(spell_thundering_throw_stun);
    register_spell_script(spell_thundering_throw);
    register_spell_script(spell_thundering_throw_forced);
    register_spell_script(spell_thundering_throw_jump);
    register_aura_script(spell_conductive_water_grow);
    register_spell_script(spell_conductive_water_dummy);
    register_aura_script(spell_conductive_water_dummy_aura);
    register_aura_script(spell_fluidity);
    register_spell_script(spell_focused_lightning_conduction);
    register_spell_script(spell_lightning_fissure_conduction);
    register_spell_script(spell_focused_lightning);
    register_aura_script(spell_ionization_aura);
    register_spell_script(spell_ionization);
    register_spell_script(spell_lightning_storm_summ);
    register_spell_script(spell_ionization_proc_conduction);
