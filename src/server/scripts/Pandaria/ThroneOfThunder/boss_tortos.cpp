...
void AddSC_boss_tortos()
{
    ...
    register_creature_script(npc_humming_crystal);
    new spell_call_of_tortos();
    new spell_rockfall_trigger_tortos();
    new spell_rockfall_damage();
    new spell_rockfall_aoe_damage();
    register_aura_script(spell_spinning_shell);
    register_spell_script(spell_shell_concussion);
    register_aura_script(spell_drain_the_weak);
    register_aura_script(spell_crystall_shell_proc);
    register_aura_script(spell_crystal_shell_mod_abs);
    new spell_tortos_quake_stomp();
    new spell_furious_stone_breath();
    new spell_teleport_all();
    new spell_waterspout_aura();
    register_spell_script(spell_tortos_knock_away);
    register_aura_script(spell_crystal_shell_aura);
