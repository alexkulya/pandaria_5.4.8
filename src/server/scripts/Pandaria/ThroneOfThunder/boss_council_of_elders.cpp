...
void AddSC_boss_council_of_elders()
{
    ...
    new npc_garajal();
    register_creature_script(npc_council_reckless_charge);
    register_creature_script(npc_garajals_soul);
    new npc_living_sand();
    register_creature_script(npc_blessed_loa_spirit);
    register_creature_script(npc_shadowed_loa_spirit);
    register_creature_script(npc_twisted_fate);
    register_aura_script(spell_garajal_possessed);
    new spell_malakk_frigid_assault();
    register_spell_script(spell_malakk_biting_cold);
    register_spell_script(spell_malakk_frostbite_selector);
    register_spell_script(spell_malakk_frostbite);
    new spell_malakk_frostbite_periodic();
    register_spell_script(spell_malakk_frostbite_allies);
    register_spell_script(spell_kazrajin_reckless_charge);
    register_spell_script(spell_kazrajin_reckless_charge_targeting);
    register_aura_script(spell_kazrajin_overload);
    register_aura_script(spell_kazrajin_discharge);
    new spell_quicksand_periodic();
    new spell_quicksand_entrapped();
    new spell_sul_sandstorm();
    register_spell_script(spell_marli_summon_blessed_loa_spirit);
    new spell_marli_summon_shadowed_loa_spirit();
    register_spell_script(spell_marli_twisted_fate_first);
    register_spell_script(spell_marli_twisted_fate_second);
    new spell_marli_twisted_fate_damages();
    new spell_dark_power();
    register_spell_script(spell_soul_fragment_target_selector);
    register_spell_script(spell_soul_fragment_switcher);
    register_spell_script(spell_marked_soul);
    new spell_shadowed_gift();
    register_aura_script(spell_council_soul_fragment);
    register_spell_script(spell_body_heat);
    register_aura_script(spell_body_heat_aura);
    register_spell_script(spell_twisted_fate_eff);
