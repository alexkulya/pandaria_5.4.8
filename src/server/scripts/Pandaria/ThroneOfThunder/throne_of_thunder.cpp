...
void AddSC_throne_of_thunder()
{
    ...
    register_creature_script(npc_waterspout_trigger);
    register_creature_script(npc_greater_cave_bat);
    register_creature_script(npc_shale_stalker);
    register_creature_script(npc_fungal_growth_2);
    register_creature_script(npc_mist_lurker);
    register_creature_script(npc_cavern_burrower);
    register_creature_script(npc_mysterious_mushroom);
    register_creature_script(npc_eternal_guardian);
    register_creature_script(npc_corpse_spider);
    register_creature_script(npc_corpse_spider_web);
    register_creature_script(npc_bow_fly_swarm);
    register_creature_script(npc_gastropod);
    register_creature_script(npc_roaming_fog);
    register_creature_script(npc_quivering_blob);
    register_creature_script(npc_thunder_lord);
    register_creature_script(npc_lightning_guardian);
    register_creature_script(npc_manchu);
    register_creature_script(npc_weishen);
    register_creature_script(npc_untrained_quilen);
    register_creature_script(npc_shanze_celestial_shaper);
    register_creature_script(npc_dark_ritualist);
    register_creature_script(npc_ritual_guard);
    register_creature_script(npc_muckbat);
    register_creature_script(npc_skittering_spiderling);
    register_creature_script(npc_rotting_scavenger);

    register_spell_script(spell_focused_lightning_aoe_trash);
    register_aura_script(spell_storm_weapon);
    register_spell_script(spell_storm_energy);
    new spell_storm_weapon_aura();
    register_spell_script(spell_flame_chanters);
    register_aura_script(spell_fiery_core);
    register_spell_script(spell_judgment_of_the_loa);
    register_spell_script(spell_conjure_elementals);
    register_spell_script(spell_summon_shadowy_minions);
    register_aura_script(spell_leishen_call_lightning);
    register_aura_script(spell_waterspout_back);
    register_spell_script(spell_eternal_siphon_life);
    register_spell_script(spell_sonic_call);
    register_spell_script(spell_luciferase);
    register_aura_script(spell_devoured);
    register_aura_script(spell_conductive_shield);
    register_spell_script(spell_triumphant_roar);
    register_spell_script(spell_cosmic_strike_summon);
    register_spell_script(spell_range_ritual_lightning);
    register_aura_script(spell_putrify_proc);
    register_spell_script(spell_corpse_spider_cocoon);
    register_aura_script(spell_throne_of_thunder_displace);
