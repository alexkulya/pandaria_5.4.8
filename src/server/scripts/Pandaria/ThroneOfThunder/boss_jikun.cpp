...
{
    new boss_jikun();
    register_creature_script(npc_egg_of_jikun);
    register_creature_script(npc_young_hatchling_jikun);
    register_creature_script(npc_juvenile);
    register_creature_script(npc_jikun_incubator);
    register_creature_script(npc_jikun_feed);
    register_creature_script(npc_pool_of_feed_effect);
    register_creature_script(npc_pool_of_feed_hatchling_effect);
    register_creature_script(npc_jump_to_boss_platform);
    register_creature_script(npc_fall_catcher_jikun);
    register_creature_script(npc_nest_guardian);
    register_creature_script(npc_jikun_golden_egg);

    register_aura_script(spell_remove_stack_wings);
    register_aura_script(spell_incubated);
    register_aura_script(spell_infected_talons);
    register_spell_script(spell_caw);
    register_aura_script(spell_hatchling_eated_aura);
    register_spell_script(spell_hatchling_eated);
    register_aura_script(spell_feed_pool_eff);
    register_aura_script(spell_quils_periodic_eff);
    register_spell_script(spell_quils_visual);
    register_aura_script(spell_incubate_visual);
    register_spell_script(spell_incubate_visual_eff);
    register_spell_script(spell_regurgitate);
    register_spell_script(spell_cheep_selector);
    register_aura_script(spell_daedalian_wings);
    register_aura_script(spell_jikun_gentle_yet_firm);
    register_spell_script(spell_jikun_pass);
    register_spell_script(spell_jikun_dropped);
