...
{
    new boss_lei_shen();
    register_creature_script(npc_thunderstruck);
    register_creature_script(npc_electric_conduit);
    register_creature_script(npc_ball_lightning);
    register_creature_script(npc_unharnessed_power);
    register_creature_script(npc_diffused_lightning);
    register_creature_script(npc_quadrant_stalker);

    register_spell_script(spell_cosmetic_teleport_side);
    register_aura_script(spell_cosmetic_visual_overcharge);
    register_aura_script(spell_decapitate);
    register_aura_script(spell_decapitate_mark);
    register_spell_script(spell_decapitate_eff);
    register_spell_script(spell_thunderstruck_selector);
    register_spell_script(spell_thunderstruck_eff);
    register_aura_script(spell_crashing_thunder_eff_proc);
    register_spell_script(spell_crashing_thunder_selector);
    register_spell_script(spell_lightning_whip_selector);
    register_spell_script(spell_ball_lightning_selector);
    register_spell_script(spell_displace);
    register_aura_script(spell_supercharge_conduits);
    register_aura_script(spell_electrical_conduit_charge);
    register_aura_script(spell_conduit_grant_ability);
    register_spell_script(spell_static_shock);
    register_spell_script(spell_static_shock_eff);
    register_spell_script(spell_overcharged);
    register_aura_script(spell_overcharged_aura);
    register_spell_script(spell_diffusion_chain_selector);
    register_spell_script(spell_diffusion_chain_eff);
    register_spell_script(spell_bouncing_bolt_selector);
    register_spell_script(spell_conduit_level_override);
    register_aura_script(spell_overwhelming_power);
    register_spell_script(spell_bouncing_bolt_eff);
    register_aura_script(spell_violent_gale_winds_eff);
    register_spell_script(spell_violent_gale_winds);
    register_aura_script(spell_violent_gale_winds_at_aura);
    register_aura_script(spell_discharged_energy_aura);
    register_spell_script(spell_ball_lightning_jump);
    register_spell_script(spell_helm_of_command);
    register_aura_script(spell_helm_of_command_aura);
    register_spell_script(spell_leishen_overcharge);
    register_spell_script(spell_leishen_overcharge_eff);
