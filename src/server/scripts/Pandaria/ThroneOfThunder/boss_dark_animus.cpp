...
void AddSC_boss_dark_animus()
{
    ...
    register_creature_script(npc_crimson_wake);
    new npc_massive_animus_golem();
    register_spell_script(spell_transfusion_missile);
    register_spell_script(spell_transfusion_orb);
    register_spell_script(spell_transfusion_intro_energize);
    register_spell_script(spell_acceleration_link);
    register_spell_script(spell_acceleration_link_selector);
    register_spell_script(spell_touch_of_the_animus);
    register_spell_script(spell_anima_font);
    register_spell_script(spell_anima_font_selector);
    register_spell_script(spell_full_power_selector);
    register_spell_script(spell_siphon_anima);
    register_spell_script(spell_anima_ring);
    register_spell_script(spell_matter_swap);
    register_aura_script(spell_matter_swap_aura);
    register_spell_script(spell_matter_swap_ally_selector);
    register_spell_script(spell_matter_swap_announce);
    register_aura_script(spell_crimson_wake_speed);
    register_spell_script(spell_crimson_wake_selector);
    register_spell_script(spell_threat_proc_eff);
    register_aura_script(spell_threat_proc);
    register_spell_script(spell_empower_golem);
    register_aura_script(spell_activation_sequence);
