...
class LifeDrainPredicate : public std::unary_function<Creature*, bool>
{
    public:
...
{
    new boss_durumu();
    register_creature_script(npc_eyebeam_target);
    register_creature_script(npc_durumu_fog);
    register_creature_script(npc_durumu_fog_achievement);
    register_creature_script(npc_durumu_eye);
    register_creature_script(npc_durumu_ice_wall);

    new spell_drain_life_damage();
    register_aura_script(spell_arterial_cut);
    register_aura_script(spell_force_of_will);
    register_spell_script(spell_beam_aoe_dmg);
    register_spell_script(spell_lingering_gaze);
    register_aura_script(spell_lingering_gaze_mark);
    register_aura_script(spell_focus_beam_precast);
    register_aura_script(spell_disintegration_beam_precast);
    register_aura_script(spell_disintegration_beam);
    register_spell_script(spell_durumu_icy_grasp);
    register_spell_script(spell_durumu_caustic_spike);
    register_spell_script(spell_durumu_mind_daggers);
    register_spell_script(spell_durumu_life_drain_eff);
    register_aura_script(spell_durumu_life_drain_eff_aura);
    register_spell_script(spell_durumu_life_drain_heal_eff);
    register_spell_script(spell_durumu_life_drain);
    register_aura_script(spell_durumu_life_drain_aura);
