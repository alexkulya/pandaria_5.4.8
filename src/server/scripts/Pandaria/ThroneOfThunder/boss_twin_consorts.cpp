...
void AddSC_boss_twin_consorts()
{
    new boss_suen();
    new boss_lulin();
    register_creature_script(npc_faded_image_of_celestial);
    register_creature_script(npc_celestial_star);
    register_creature_script(npc_moon_lotus_wave);
    register_creature_script(npc_crashing_star);
    register_creature_script(npc_beast_of_nightmares);
    register_creature_script(npc_ice_comet);
    register_creature_script(npc_lurker_in_the_night);

    register_spell_script(spell_tear_of_the_sun_selector);
    register_spell_script(spell_tear_of_the_sun_eff);
    register_aura_script(spell_tear_of_the_sun);
    register_spell_script(spell_light_of_day_selector);
    register_aura_script(spell_blazing_radiance);
    register_aura_script(spell_moon_lotus_bloom_aura);
    register_spell_script(spell_moon_lotus_bloom_aura_eff);
    register_spell_script(spell_moon_lotus_bloom);
    register_spell_script(spell_crashing_star_jump);
    register_spell_script(spell_celestial_summon_star);
    register_aura_script(spell_twin_consort_dissipate);
    register_aura_script(spell_moon_lotus_periodic);
    register_spell_script(spell_moon_lotus_hide_selector);
    register_spell_script(spell_moon_lotus_reappear_selector);
    register_aura_script(spell_cosmic_barrage);
    register_spell_script(spell_cosmic_barrage_summon);
    register_aura_script(spell_launch_star);
    register_spell_script(spell_launch_star_eff);
    register_spell_script(spell_flames_of_passion_charge_back);
    register_spell_script(spell_flames_of_passion_eff);
    register_spell_script(spell_flames_of_passion_charge);
    register_spell_script(spell_ice_comet_selector);
    register_spell_script(spell_despawn_ice_comet);
    register_spell_script(spell_ice_comet_chilled);
    register_spell_script(spell_tidal_force);
    register_aura_script(spell_beast_of_nightmares);
    register_spell_script(spell_expose_lurkers);
    register_spell_script(spell_lurker_darkness);
    register_aura_script(spell_nuclear_inferno);
    register_spell_script(spell_nuclear_inferno_eff);
    register_aura_script(spell_lurker_invis);
    register_spell_script(spell_celestial_uninteractible);
    register_aura_script(spell_celestial_uninteractible_aura);
    register_spell_script(spell_celestial_link_star);
    register_spell_script(spell_celestial_cancel_beams);
    register_spell_script(spell_huen_blessed_alacrity);
    register_spell_script(spell_fortitude_of_the_ox);
    register_spell_script(spell_light_of_day_second_eff);
    register_aura_script(spell_fortitude_of_the_ox_eff);
