...
class ArcingLightningSwitchPredicate : public std::unary_function<Unit*, bool>
{
    public:
...
void AddSC_boss_iron_qon()
{
    ...
    register_creature_script(npc_rushing_wind);
    register_creature_script(npc_lightnig_cloud);
    register_spell_script(spell_unleashed_flame_selector);
    register_spell_script(spell_unleashed_flame_eff);
    register_spell_script(spell_rushing_wind_pull);
    register_spell_script(spell_rushing_wind_targeting);
    register_aura_script(spell_storm_cloud_eff);
    register_spell_script(spell_arcing_lightning_selector);
    register_aura_script(spell_arcing_lightning);
    register_spell_script(spell_arcing_lightning_proc_selector);
    register_aura_script(spell_arcing_lightning_proc_eff_aura);
    register_spell_script(spell_arcing_lightning_proc_eff);
    register_spell_script(spell_arcing_lightning_proc_selector_2);
    register_spell_script(spell_freeze_selector);
    register_aura_script(spell_freeze_aura);
    register_aura_script(spell_frozen_resilence);
    register_spell_script(spell_dead_zone);
    register_aura_script(spell_molten_overload);
    register_spell_script(spell_throw_spear_missle_eff);
    register_spell_script(spell_rushing_winds_misc);
    register_spell_script(spell_enchant_cyclone_ignite);
    register_spell_script(spell_enchant_cyclone_freeze);
    register_aura_script(spell_rushing_winds_vehicle_aura);
    register_spell_script(spell_rushing_winds_vehicle);
    register_spell_script(spell_frost_spike_selector);
