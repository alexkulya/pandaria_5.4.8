...
{
    register_creature_script(npc_siege_of_orgrimmar_ooze_controller);
    register_creature_script(npc_siege_of_orgrimmar_lesser_sha_puddle);
    register_creature_script(npc_tormented_initiate);
    register_creature_script(npc_fallen_pool_tender);
    register_creature_script(npc_aqueous_defender);
    register_creature_script(npc_siege_of_orgrimmar_lorewalker_cho);
    register_creature_script(npc_siege_of_orgrimmar_lorewalker_cho_norushen);
    register_creature_script(npc_vanity);
    register_creature_script(npc_fragment_of_pride);
    register_creature_script(npc_amalgamated_hubris);
    register_creature_script(npc_zeal);
    register_creature_script(npc_lingering_corruption);
    register_creature_script(npc_pressure_plate);
    register_creature_script(npc_siege_of_orgrimmar_portal_to_galakras);
    register_creature_script(npc_lady_jaina_proudmoore_sha_room);
    register_creature_script(npc_dragonmaw_tidal_shaman);
    register_creature_script(npc_dragonmaw_bonecrusher);
    register_creature_script(npc_dragonmaw_elite_grunt);
    register_creature_script(npc_pressure_mine);
    register_creature_script(npc_siege_of_orgrimmar_korkron_elite_sniper);
    register_creature_script(npc_siege_of_orgrimmar_voljin);
    register_creature_script(npc_siege_of_orgrimmar_tyrande);
    register_creature_script(npc_siege_of_orgrimmar_korkron_grunt_gates);
    register_creature_script(npc_siege_of_orgrimmar_aysa_cloudsinger);
    register_creature_script(npc_siege_of_orgrimmar_blind_blademaster);
    register_creature_script(npc_siege_of_orgrimmar_korkron_dark_shaman);
    register_creature_script(npc_siege_of_orgrimmar_poison_bolt_totem);
    register_creature_script(npc_siege_of_orgrimmar_korkron_grunt_2);
    register_creature_script(npc_siege_of_orgrimmar_overseeker_mojka);
    register_creature_script(npc_siege_of_orgrimmar_treasure_guard);
    register_creature_script(npc_overseer_komak);
    register_creature_script(npc_siege_of_orgrimmar_mokvar_the_treasurer);
    register_creature_script(npc_siege_of_orgrimmar_cage_prisoner);
    register_creature_script(npc_siege_of_orgrimmar_resistance_totem);
    register_creature_script(npc_siege_of_orgrimmar_korkron_shadowmage);
    register_creature_script(npc_siege_of_orgrimmar_korkron_overseer);
    register_creature_script(npc_siege_of_orgrimmar_korkron_dire_wolf);
    register_creature_script(npc_siege_of_orgrimmar_eitrigg);
    register_creature_script(npc_siege_of_orgrimmar_overlord_runthak);
    register_creature_script(npc_siege_of_orgrimmar_hellscream_demolisher);
    register_creature_script(npc_siege_of_orgrimmar_groldar);
    register_creature_script(npc_siege_of_orgrimmar_doomlord);
    register_creature_script(npc_siege_of_orgrimmar_korkron_blood_axe);
    register_creature_script(npc_siege_of_orgrimmar_korkron_gunner);
    register_creature_script(npc_siege_of_orgrimmar_korkron_dark_farseer);
    register_creature_script(npc_siege_of_orgrimmar_korkron_dark_wolf);
    register_creature_script(npc_siege_of_orgrimmar_hellscream_annihilator);
    register_creature_script(npc_siege_of_orgrimmar_korkron_skull_splitter);
    register_creature_script(npc_siege_of_orgrimmar_corrupted_skullsplitter);
    register_creature_script(npc_siege_of_orgrimmar_korkron_iron_scorpion);
    register_creature_script(npc_siege_of_orgrimmar_arcweaver_reinforcements);
    register_creature_script(npc_siege_of_orgrimmar_brute_reinforcements);
    register_creature_script(npc_siege_of_orgrimmar_storeroom_guard);
    register_creature_script(npc_siege_of_orgrimmar_korkron_jailer_thrash);
    register_creature_script(npc_korkron_iron_sentinel);
    register_creature_script(npc_siege_of_orgrimmar_korkron_gunner_rp_event);
    register_creature_script(npc_war_master_kragg);
    register_creature_script(npc_siege_of_orgrimmar_thresher_turret);
    register_creature_script(npc_siege_of_orgrimmar_enraged_mushan_beast);
    register_creature_script(npc_siege_of_orgrimmar_starved_yeti);
    register_creature_script(npc_siege_of_orgrimmar_aggron);
    register_creature_script(npc_siege_of_orgrimmar_blackfuse_korkron_overseer);
    register_creature_script(npc_siege_of_orgrimmar_blackfuse_sellsword);
    register_creature_script(npc_siege_of_orgrimmar_blackfuse_engineer);
    register_creature_script(npc_siege_of_orgrimmar_gorodan);
    register_creature_script(npc_siege_of_orgrimmar_shanna_sparkfizz);
    register_creature_script(npc_klaxxi_srathik_amber_master);
    register_creature_script(npc_klaxxi_korthik_honor_guard);
    register_creature_script(npc_klaxxi_kovok);
    register_creature_script(npc_klaxxi_grand_master_alchemist_kixen);
    register_creature_script(npc_siege_of_orgrimmar_overlord_saurfang);
    register_creature_script(npc_siege_of_orgrimmar_thrall);
    register_creature_script(npc_siege_of_orgrimmar_blood_of_yshaarj_trigger);
    register_creature_script(npc_siege_of_orgrimmar_ichor_of_yshaarj);
    register_creature_script(npc_siege_of_orgrimmar_harbinger_of_yshaarj);
    register_creature_script(npc_siege_of_orgrimmar_korkron_reaper);
    register_creature_script(npc_siege_of_orgrimmar_gamon);
    register_creature_script(npc_siege_of_orgrimmar_dancing_flame);
    register_creature_script(npc_siege_of_orgrimmar_sha_cloud);
    register_creature_script(npc_siege_of_orgrimmar_korkron_prisoners);
    register_creature_script(npc_siege_of_orgrimmar_theramore_prisoners);
    new go_siege_of_orgrimmar_korkron_cage();
    new go_siege_of_orgrimmar_siegecrafter_iron_door();

    register_spell_script(spell_aqueous_defender_vortex);
    register_spell_script(spell_aqueous_defender_vortex_eff);
    register_aura_script(spell_rushing_waters_eff);
    register_spell_script(spell_growing_pride);
    register_spell_script(spell_zeal_sha_smash);
    register_spell_script(spell_corrupted_touch);
    register_aura_script(spell_corrupted_touch_aura);
    register_spell_script(spell_siege_mighty_stomp);
    register_spell_script(spell_resonating_amber);
    register_aura_script(spell_siege_of_orgrimmar_ten_percent_of_health);
    register_spell_script(spell_dragonmaw_tidal_wave);
    register_spell_script(spell_bonecrusher_fracture_eff);
    register_aura_script(spell_siege_of_orgrimmar_sniped);
    register_spell_script(spell_siege_of_orgrimmar_blade_salvo);
    register_aura_script(spell_siege_of_orgrimmar_bribe);
    register_spell_script(spell_siege_of_orgrimmar_fire_storm_selector);
    register_spell_script(spell_siege_of_orgrimmar_umbral_tempest_selector);
    register_spell_script(spell_siege_of_orgrimmar_scorched_selector);
    register_spell_script(spell_siege_of_orgrimmar_skullspitters_rage);
    register_spell_script(spell_siege_of_orgrimmar_acid_spray_selector);
    register_spell_script(spell_siege_of_orgrimmar_infusion);
    register_spell_script(spell_siege_of_orgrimmar_call_reinforcements);
    register_spell_script(spell_siege_of_orgrimmar_cannon_blast);
    register_spell_script(spell_siege_of_orgrimmar_spike_mine_detonation);
    register_spell_script(spell_siege_of_orgrimmar_portal_to_orgrimmar);
    register_spell_script(spell_siege_of_orgrimmar_strength_in_numbers_eff);
    register_spell_script(spell_siege_of_orgrimmar_shredding_blast_selector);
    register_spell_script(spell_siege_of_orgrimmar_envenomed_shadowstep);
    register_spell_script(spell_siege_of_orgrimmar_fan_of_knives);
    register_aura_script(spell_siege_of_orgrimmar_drillstorm);
    register_aura_script(spell_siege_of_orgrimmar_call_of_the_elements);
    register_spell_script(spell_siege_of_orgrimmar_attack_thrall);
    register_aura_script(spell_siege_of_orgrimmar_blood_of_yshaarj);
    register_spell_script(spell_siege_of_orgrimmar_empowering_corruption);
    register_spell_script(spell_siege_of_orgrimmar_summon_blood_of_yshaarj_eff);
    register_spell_script(spell_siege_of_orgrimmar_reaper_charge);
    register_spell_script(spell_siege_of_orgrimmar_dancing_flames);
    register_spell_script(spell_siege_of_orgrimmar_slave_chains);
    register_spell_script(spell_siege_of_orgrimmar_ground_slam);
