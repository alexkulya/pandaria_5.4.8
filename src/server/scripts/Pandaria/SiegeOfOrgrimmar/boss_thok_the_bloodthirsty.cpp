...
void AddSC_thok_the_bloodthirsty()
{
    ...
    register_creature_script(npc_korkron_jailer);
    register_creature_script(npc_akolik);
    register_creature_script(npc_soo_waterspeaker_gorai);
    register_creature_script(npc_montak);
    register_creature_script(npc_thok_helper_base);
    register_creature_script(npc_thok_ice_tomb);
    register_creature_script(npc_thok_shock_collar);
    register_creature_script(npc_thok_captive_cave_bat);
    register_creature_script(npc_thok_starved_yeti);
    register_creature_script(npc_thok_monstrous_gastropod);
    new go_thok_helper_prisons();
    new go_thok_third_locked_cage();

    register_spell_script(spell_thok_kill_jailers);
    register_spell_script(spell_thok_shock_blast);
    register_spell_script(spell_thok_shock_blast_eff);
    register_spell_script(spell_thok_power_regen_eff);
    register_aura_script(spell_thok_acceleration);
    register_spell_script(spell_thok_clump_check);
    register_spell_script(spell_thok_fixate);
    register_aura_script(spell_thok_fixate_aura);
    register_spell_script(spell_thok_corrosive_blood);
    register_spell_script(spell_thok_corrosive_blood_eff);
    register_spell_script(spell_thok_icy_blood);
    register_spell_script(spell_thok_icy_blood_eff);
    register_aura_script(spell_thok_icy_blood_eff_aura);
    register_aura_script(spell_thok_summon_ice_tomb_stun);
    register_spell_script(spell_thok_burning_blood);
    register_spell_script(spell_thok_burning_blood_selector);
    register_spell_script(spell_thok_akolik_incantation);
    register_aura_script(spell_thok_bloodied);
    register_aura_script(spell_thok_skeleton_key);
    register_spell_script(spell_thok_unlocking);
    register_aura_script(spell_thok_freezing_breath);
    register_aura_script(spell_thok_shock_blast_bloodied);
    register_aura_script(spell_thok_flame_coating);
    register_spell_script(spell_thok_deafening_screech);
    register_spell_script(spell_thok_wrecking_ball);
    register_spell_script(spell_thok_vampiric_frenzy);
    register_aura_script(spell_thok_vampiric_frenzy_aura);
    register_aura_script(spell_thok_wrecking_ball_visual);
    register_spell_script(spell_thok_fearsome_roar);
    register_spell_script(spell_thok_summon_ice_tomb);
    register_spell_script(spell_thok_dummy_nuke);
    register_aura_script(spell_thok_mega_snail_vs_giant_dinosaur_morph);
