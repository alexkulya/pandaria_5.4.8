...
{
    new boss_immerseus();
    register_creature_script(npc_sha_splash_bolt_immerseus);
    register_creature_script(npc_swirl_immerseus);
    register_creature_script(npc_swirl_target_immerseus);
    register_creature_script(npc_sha_puddle_immerseus);
    register_creature_script(npc_contaminated_puddle_immerseus);
    register_creature_script(npc_tears_of_the_vale);

    register_spell_script(spell_immerseus_sha_bolt);
    register_spell_script(spell_swirl_spray);
    register_aura_script(spell_immersius_swirl_at_aura);
    register_spell_script(spell_immerseus_split);
    register_spell_script(spell_immerseus_reform);
    register_aura_script(spell_immerseus_congealing);
    register_aura_script(spell_immerseus_swirl_aura);
    register_spell_script(spell_immerseus_split_sha_missle_eff);
    register_aura_script(spell_immerseus_sha_splash_eff);
    register_spell_script(spell_immerseus_swelling_corruption_ann);
    register_aura_script(spell_immersius_swelling_corruption);
    register_spell_script(spell_immerseus_swelling_corruption_summ);
    register_spell_script(spell_immerseus_sha_pool_puddles_ping);
    register_aura_script(spell_immerseus_sha_pool);
    register_spell_script(spell_immerseus_sha_pool_players_ping);
    register_aura_script(spell_immerseus_sha_pool_players_ping_aura);
    register_spell_script(spell_immerseus_seeping_sha_eff);
    register_aura_script(spell_immersius_split_aura);
    register_aura_script(spell_immerseus_sha_corruption_eff);
