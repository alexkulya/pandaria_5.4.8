...
void AddSC_galakras()
{
    ...
    register_creature_script(npc_master_cannoneer_dagryn);
    register_creature_script(npc_high_enforcer_thranok);
    register_creature_script(npc_lieutenant_krugruk);
    register_creature_script(npc_korgra_the_snake);
    register_creature_script(npc_galakras_dragonmaw_bonecrusher);
    register_creature_script(npc_galakras_dragonmaw_flagbearer);
    register_creature_script(npc_galakras_dragonmaw_tidal_shaman);
    register_creature_script(npc_galakras_dragonmaw_flameslinger);
    register_creature_script(npc_galakras_dragonmaw_war_banner);
    register_creature_script(npc_galakras_healing_tide_totem);
    register_creature_script(npc_galakras_dragonmaw_grunt);
    register_creature_script(npc_galakras_dragonmaw_grunt_tower);
    register_creature_script(npc_galakras_dragonmaw_proto_drake);
    register_creature_script(npc_galakras_korkron_demolisher);
    register_creature_script(npc_galakras_varian_wrynn);
    register_creature_script(npc_galakras_sylvanas_windrunner);
    register_creature_script(npc_galakras_aethas_sunreaver);
    register_creature_script(npc_galakras_vereesa_windrunner);
    new npc_galakras_jaina_proudmoore();
    new npc_galakras_lorthemar_theron();
    register_creature_script(npc_galakras_demolitions_expert);
    register_creature_script(npc_galakras_ally_range_assist);
    register_creature_script(npc_galakras_ally_melee_assist);
    register_creature_script(npc_galakras_anti_air_cannon);
    register_creature_script(npc_galakras_dragonmaw_ebon_stalker);
    register_creature_script(npc_galakras_rope);

    register_spell_script(spell_galakras_crushers_call_selector);
    register_spell_script(spell_galakras_crushers_call_chain_eff);
    register_aura_script(spell_most_complicated_bomb_in_the_world);
    register_spell_script(spell_galakras_anti_air_cannon_eff);
    register_aura_script(spell_galakras_anti_air_cannon_eff_aura);
    register_spell_script(spell_galakras_anti_air_cannon_missle);
    register_aura_script(spell_galakras_in_a_tower);
    register_spell_script(spell_galakras_shattering_roar);
    register_spell_script(spell_galakras_healing_tide_eff);
    register_spell_script(spell_galakras_dragonmaw_tidal_wave);
    register_spell_script(spell_galakras_poison_blast);
    register_spell_script(spell_galakras_flame_arrows);
    register_aura_script(spell_galakras_tower_strength);
    register_aura_script(spell_galakras_tower_strength_north);
    register_aura_script(spell_galakras_flames_of_galakrond);
    register_aura_script(spell_galakras_healing_tide_proc);
    register_spell_script(spell_galakras_drakefire_selector);
    register_spell_script(spell_galakras_shadow_stalk);
    register_aura_script(spell_galakras_fracture);
    register_aura_script(spell_galakras_flames_of_galakrond_periodic);
    register_aura_script(spell_galakras_fixate);
    register_spell_script(spell_galakras_flame_arrows_selector);
