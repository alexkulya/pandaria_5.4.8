...
{
    new boss_malkorok();
    register_creature_script(npc_malkorok_implosion);
    register_creature_script(npc_malkorok_arcing_smash);
    register_creature_script(npc_malkorok_ancient_miasma);
    register_creature_script(npc_malkorok_controller);
    register_creature_script(npc_malkorok_living_corruption);

    register_spell_script(spell_malkorok_implosion_cosmetic);
    register_spell_script(spell_malkorok_siesmic_slam_selector);
    register_spell_script(spell_malkorok_arcing_smash_preparation);
    register_spell_script(spell_malkorok_arcing_smash_controll);
    register_aura_script(spell_malkorok_arcing_smash_visual_cast);
    register_spell_script(spell_malkorok_breath_of_yshaarj);
    register_spell_script(spell_malkorok_eradicate);
    register_spell_script(spell_malkorok_blood_rage);
    register_aura_script(spell_malkorok_ancient_miasma_heal_absorb);
    register_aura_script(spell_malkorok_ancient_barrier);
    register_spell_script(spell_malkorok_imploding_energy_selector);
    register_spell_script(spell_malkorok_ancient_miasma_leave_body);
    register_aura_script(spell_malkorok_blood_rage_aura);
    register_spell_script(spell_malkorok_expel_miasma);
    register_spell_script(spell_malkorok_displaced_energy);
    register_aura_script(spell_malkorok_displaced_energy_aura);
    register_spell_script(spell_malkorok_displaced_energy_eff);
    register_spell_script(spell_malkorok_essence_of_yshaarj_trigger_eff);
    register_aura_script(spell_malkorok_essence_of_yshaarj_launcher);
    register_spell_script(spell_malkorok_yshaarj_corruption);
    register_aura_script(spell_malkorok_yshaarj_corruption_aura);
