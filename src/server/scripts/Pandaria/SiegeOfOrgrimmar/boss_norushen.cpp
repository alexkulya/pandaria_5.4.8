...
void AddSC_norushen()
{
    ...
    register_creature_script(npc_manifestation_of_corruption);
    register_creature_script(npc_essence_of_corruption);
    register_creature_script(npc_greater_corruption);
    register_creature_script(npc_titanic_corruption);
    register_creature_script(npc_blind_hatred);
    register_creature_script(npc_residual_corruption);
    register_creature_script(npc_quarantine_measures);
    register_creature_script(npc_purifying_light_orb);
    register_creature_script(npc_test_of_reliance_helpers);

    register_aura_script(spell_amalgam_corruption_bar);
    register_spell_script(spell_amalgam_unleashed_anger);
    register_spell_script(spell_amalgam_icy_fear);
    register_aura_script(spell_test_realm_amalgam);
    register_aura_script(spell_blind_hatred_periodic);
    register_spell_script(spell_blind_hatred_eff);
    register_spell_script(spell_norushen_teleport);
    register_spell_script(spell_essence_unleash_corruption);
    register_spell_script(spell_manifestation_unleash_corruption);
    register_spell_script(spell_bottomless_pit);
    register_spell_script(spell_bottomless_pit_player_selector);
    register_spell_script(spell_norushen_lingering_corruption);
    register_spell_script(spell_tear_reality);
    register_spell_script(spell_titanic_burst_of_corruption);
    register_spell_script(spell_titanic_titanic_smash);
    register_aura_script(spell_look_within);
    register_spell_script(spell_unleash_corruption_summ);
    register_aura_script(spell_norushen_purified);
