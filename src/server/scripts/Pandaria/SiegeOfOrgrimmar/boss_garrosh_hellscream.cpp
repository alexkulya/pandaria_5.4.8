...
void AddSC_garrosh_hellscream()
{
    ...
    register_creature_script(npc_siege_engineer);
    register_creature_script(npc_korkron_warbringer);
    register_creature_script(npc_wolf_rider_farseer);
    register_creature_script(npc_soo_desecrated_weapon);
    register_creature_script(npc_soo_iron_star);
    register_creature_script(npc_soo_embodied_minions);
    register_creature_script(npc_soo_heart_of_yshaarj);
    register_creature_script(npc_garrosh_heart_of_yshaarj_realm);
    register_creature_script(npc_garrosh_minion_of_yshaarj);
    register_creature_script(npc_garrosh_unstable_iron_star);

    register_spell_script(spell_soo_hellscreams_warsong);
    register_aura_script(spell_soo_power_iron_star);
    register_aura_script(spell_garrosh_realm_of_yshaarj);
    register_aura_script(spell_soo_yshaarjs_protection_aura);
    register_spell_script(spell_soo_yshaarjs_protection);
    register_aura_script(spell_soo_whirling_corruption);
    register_aura_script(spell_soo_empowered_gripping_despair);
    register_aura_script(spell_garrosh_explosive_despair_eff);
    register_aura_script(spell_soo_transition_phase_third_effect);
    register_aura_script(spell_garrosh_consumed_hope);
    register_spell_script(spell_garrosh_desecrate_selector);
    register_aura_script(spell_garrosh_phase_two_transform);
    register_spell_script(spell_garrosh_phase_two_transform_eff);
    register_spell_script(spell_garrosh_exploding_iron_star);
    register_spell_script(spell_garrosh_touch_of_yshaarj);
    register_aura_script(spell_garrosh_touch_of_yshaarj_aura);
    register_spell_script(spell_garrosh_empowered_touch_of_yshaarj);
    register_aura_script(spell_garrosh_empowered_touch_of_yshaarj_aura);
    register_aura_script(spell_garrosh_touch_of_yshaarj_player_eff_aura);
    register_spell_script(spell_garrosh_empowering_corruption);
    register_spell_script(spell_garrosh_empowering_corruption_heroic);
    register_spell_script(spell_garrosh_enter_realm_of_yshaarj_launcher);
    register_spell_script(spell_garrosh_teleport_to_realms);
    register_spell_script(spell_garrosh_consumed_courage);
    register_spell_script(spell_garrosh_consumed_faith);
    register_spell_script(spell_garrosh_whirling_corruption);
    register_spell_script(spell_garrosh_empowered_desecrate_summon);
    register_aura_script(spell_garrosh_garrosh_energy);
    register_spell_script(spell_garrosh_growing_power);
    register_spell_script(spell_garrosh_touch_of_yshaarj_player_launcher);
    register_spell_script(spell_garrosh_ancestral_chain_heal);
    register_spell_script(spell_garrosh_power_of_the_old_god);
    register_spell_script(spell_garrosh_empowered_whirling_missle);
    register_spell_script(spell_garrosh_touch_of_yshaarj_player_launcher_2);
    register_spell_script(spell_garrosh_malice);
    register_spell_script(spell_garrosh_malice_selector);
    register_spell_script(spell_garrosh_bombardment_selector);
    register_aura_script(spell_garrosh_manifest_rage);
    register_spell_script(spell_garrosh_fire_iron_star_selector);
    register_aura_script(spell_garrosh_enter_realm_of_garrosh_eff);
    register_spell_script(spell_garrosh_clump_check);
    register_aura_script(spell_garrosh_call_bombardment);
    register_spell_script(spell_garrosh_bombardment_force);
    register_spell_script(spell_garrosh_iron_star_fixate_selector);
    register_aura_script(spell_garrosh_iron_star_fixate);
    register_aura_script(spell_garrosh_unstable_iron_star_garrosh_eff);
    register_spell_script(spell_garrosh_blood_frenzied_selector);
    register_spell_script(spell_garrosh_crushing_fear_selector);
    register_spell_script(spell_garrosh_manifistation_of_rage_eff);
    register_spell_script(spell_garrosh_iron_star_crater);
    register_spell_script(spell_garrosh_annihilate);
    register_spell_script(spell_garrosh_faith_missle);
    register_spell_script(spell_garrosh_jump_to_ground);
