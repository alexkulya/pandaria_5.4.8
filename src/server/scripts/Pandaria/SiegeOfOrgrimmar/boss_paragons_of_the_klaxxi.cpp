...
void AddSC_paragons_of_the_klaxxi()
{
    ...
    register_creature_script(boss_kilruk_the_wind_reaver);
    register_creature_script(boss_xaril_the_poisoned_mind);
    register_creature_script(boss_kaztik_the_manipulator);
    register_creature_script(boss_korven_the_prime);
    register_creature_script(boss_iyyokuk_the_lucid);
    register_creature_script(boss_karoz_the_locust);
    register_creature_script(boss_skeer_the_bloodseeker);
    register_creature_script(boss_rikkal_the_dissector);
    register_creature_script(boss_hisek_the_swarmkeeper);
    register_creature_script(npc_paragon_mantid_amber);
    register_creature_script(npc_soo_paragon_hungry_kunchong);
    register_creature_script(npc_blood);
    register_creature_script(npc_soo_paragon_amber);
    register_creature_script(npc_paragon_amber_parasite);
    register_creature_script(npc_paragon_amber_bomb);
    register_creature_script(npc_paragon_eerie_fog);

    register_spell_script(spell_soo_paragon_purpose);
    register_aura_script(spell_soo_cosmetic_for_fight_starter);
    register_spell_script(spell_soo_paragon_berserk);
    register_aura_script(spell_soo_paragon_gouge);
    register_spell_script(spell_soo_paragon_toxic_injection);
    register_spell_script(spell_paragon_caustic_blood);
    register_aura_script(spell_paragon_caustic_blood_aura);
    register_spell_script(spell_soo_catalyst_react_blue);
    register_spell_script(spell_soo_catalyst_react_red);
    register_spell_script(spell_soo_catalyst_react_yellow);
    register_spell_script(spell_soo_catalyst_react_purple);
    register_spell_script(spell_soo_catalyst_react_orange);
    register_spell_script(spell_soo_catalyst_react_green);
    register_spell_script(spell_soo_paragon_shield_bash);
    register_aura_script(spell_soo_vicious_assault);
    register_spell_script(spell_soo_bloodletting);
    register_spell_script(spell_paragon_injection);
    register_aura_script(spell_paragon_injection_aura);
    register_spell_script(spell_soo_paragon_diminish);
    register_spell_script(spell_soo_insane_calculation_fiery_edge);
    register_aura_script(spell_soo_aim_aura);
    register_spell_script(spell_soo_aim);
    register_spell_script(spell_soo_aim_resonance);
    register_spell_script(spell_soo_amber_regeneration);
    register_aura_script(spell_soo_devour);
    register_spell_script(spell_paragon_jump_to_center);
    register_spell_script(spell_paragon_mutate_selector);
    register_spell_script(spell_paragon_vicious_assault_rapture);
    register_spell_script(spell_paragon_reaction_blue);
    register_spell_script(spell_paragon_mesmerize);
    register_aura_script(spell_paragon_fiery_edge_beam);
    register_aura_script(spell_paragon_fiery_edge_periodic);
    register_spell_script(spell_paragon_fiery_edge_eff);
    register_aura_script(spell_paragon_encase_in_amber);
    register_spell_script(spell_paragon_feed);
    register_aura_script(spell_paragon_genetic_modification);
    register_spell_script(spell_paragon_multi_shot);
    register_spell_script(spell_paragon_point_blank_shot);
    register_spell_script(spell_paragon_store_kinetic_energy);
    register_spell_script(spell_paragon_whirling);
    register_spell_script(spell_paragon_summon_paragons);
    register_spell_script(spell_paragon_snipe);
    register_aura_script(spell_paragon_bloodletting_proc);
    register_spell_script(spell_paragon_tenderizing_strikes);
    register_spell_script(spell_paragon_exposed_veins);
    register_spell_script(spell_paragon_hewn);
    register_spell_script(spell_paragon_genetic_alteration);
    register_spell_script(spell_paragon_kunchlong_energize);
    register_spell_script(spell_paragon_hurl_amber_selector);
    register_aura_script(spell_paragon_hurl_amber_launch);
    register_spell_script(spell_paragon_devour_instakill);
    register_spell_script(spell_paragon_bloodletting_summon);
    register_spell_script(spell_paragon_prey);
    register_aura_script(spell_paragon_rapid_rife);
    register_aura_script(spell_paragon_faulty_mutation);
    register_spell_script(spell_paragon_sonic_pulse);
    register_spell_script(spell_paragon_reave_eff_heroic);
    register_spell_script(spell_paragon_reave_selector);
    register_spell_script(spell_paragon_reave_launcher);
    register_aura_script(spell_paragon_reave_heroic);
    register_aura_script(spell_paragon_volatile_poultice);
    register_aura_script(spell_paragon_volatile_poultice_storage);
    register_spell_script(spell_paragon_player_reave);
    register_spell_script(spell_paragon_player_reave_eff);
    register_spell_script(spell_paragon_mutation_ability_eff);
    register_aura_script(spell_paragon_encase_in_amber_player);
    register_aura_script(spell_paragons_award);
    register_spell_script(spell_paragon_explosive_ring_visual);
