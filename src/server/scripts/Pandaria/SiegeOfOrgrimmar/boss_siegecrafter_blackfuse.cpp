...
void AddSC_siegecrafter_blackfuse()
{
    ...
    register_creature_script(npc_automated_shredder);
    register_creature_script(npc_siegecrafter_sawblade);
    register_creature_script(npc_soo_siegecrafter_helper);
    register_creature_script(npc_soo_deactivated_weapons);
    register_creature_script(npc_soo_activated_weapons);
    register_creature_script(npc_soo_activated_weapons_type);
    register_creature_script(npc_soo_laser_target_bunny);
    register_creature_script(npc_soo_laser_array_bunny);
    register_creature_script(npc_soo_shockwave_missle);
    register_creature_script(npc_siegecrafter_shockwave_missle_trigger);

    register_spell_script(spell_soo_shockwave_missle);
    register_aura_script(spell_soo_electromagnetic_barrier);
    register_spell_script(spell_soo_electromagnetic_barrier_eff);
    register_spell_script(spell_soo_shockwave_missle_throw);
    register_aura_script(spell_soo_crawler_mine_break_in_period);
    register_aura_script(spell_soo_crawler_mine_ready_to_go);
    register_spell_script(spell_soo_launch_sawblade);
    register_spell_script(spell_soo_shredder_overcharge);
    register_spell_script(spell_siegecrafter_launch_sawblade_jump);
    register_spell_script(spell_siegecrafter_laser_turret_selector);
    register_spell_script(spell_siegecrafter_energized_defensive_matrix);
    register_aura_script(spell_siegecrafter_crawler_mine_controller_periodic);
    register_spell_script(spell_siegecrafter_magnetic_pulse_selector);
    register_aura_script(spell_siegecrafter_magnetic_pulse_past_eff);
    register_aura_script(spell_siegecrafter_on_conveyor);
    register_spell_script(spell_siegecrafter_crawler_mine_selector);
    register_aura_script(spell_siegecrafter_crawler_mine_fixate);
    register_spell_script(spell_siegecrafter_crawler_mine_detonate);
    register_aura_script(spell_siegecrafter_pipe_transfert_platform_to_underhold);
    register_spell_script(spell_siegecrafter_deathdealer_laser_targeting);
    register_aura_script(spell_siegecrafter_conveyor_death_beam_hc);
    register_spell_script(spell_siegecrafter_overcharge_weapon);
    register_spell_script(spell_siegecrafter_magnetic_crush_push_saw);
    register_spell_script(spell_siegecrafter_magnetic_crush_pull_saw);
    register_aura_script(spell_siegecrafter_magnetic_crush_invert);
    register_aura_script(spell_siegecrafter_disintegration_laser);
    register_aura_script(spell_siegecrafter_superheated_periodic);
    register_spell_script(spell_siegecrafter_pattern_recognition);
    register_aura_script(spell_siegecrafter_electrostatic_charge);
