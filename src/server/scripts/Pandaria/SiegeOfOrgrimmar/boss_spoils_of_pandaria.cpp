...
void AddSC_spoils_of_pandaria()
{
    ...
    register_creature_script(npc_spoils_artifact_spoils);
    register_creature_script(npc_spoils_lever);
    register_creature_script(npc_modified_anima_golem);
    register_creature_script(npc_mogu_shadow_ritualist);
    register_creature_script(npc_zarthik_amber_priest);
    register_creature_script(npc_setthik_wielder);
    register_creature_script(npc_animated_stone_mogu);
    register_creature_script(npc_burial_urn);
    register_creature_script(npc_shadow_ritualist_phylactery);
    register_creature_script(npc_quilen_guardians_controller);
    register_creature_script(npc_spoils_quilen_guardian);
    register_creature_script(npc_srithik_bombardier);
    register_creature_script(npc_korthik_warcaller);
    register_creature_script(npc_spoils_mogu_warlord);
    register_creature_script(npc_spoils_mantid_commander);
    register_creature_script(npc_spoils_amber_encased_kunchong);
    register_creature_script(npc_spoils_lift_hook);
    register_creature_script(npc_spoils_ancient_brewmaster_spirit);
    register_creature_script(npc_spoils_wise_mistweaver_spirit);
    register_creature_script(npc_spoils_nameless_windwalker_spirit);
    register_creature_script(npc_spoils_spark_of_life);
    register_creature_script(npc_spoils_pandarens_gift);
    register_creature_script(npc_spoils_zarthik_swarmer);
    register_creature_script(npc_spoils_stone_statue_warlord);
    register_creature_script(npc_spoils_unstable_spark);
    new go_spoils_secured_stockpile_of_spoils();
    new go_spoils_lever();

    register_spell_script(spell_spoils_unstable_defense_system_initialize);
    register_spell_script(spell_spoils_breaking);
    register_aura_script(spell_spoils_stone_statue);
    register_aura_script(spell_spoils_pandaren_spirit_spawn);
    register_spell_script(spell_spoils_lever_eff);
    register_aura_script(spell_spoils_encapsulated_pheromones_periodic);
    register_aura_script(spell_spoils_gusting_bomb_periodic);
    register_spell_script(spell_spoils_rage_of_empress);
    register_spell_script(spell_spoils_residue);
    register_spell_script(spell_spoils_mantid_swarm);
    register_aura_script(spell_spoils_pheromone_cloud);
    register_aura_script(spell_spoils_set_to_blow_button);
    register_spell_script(spell_spoils_set_to_blow_eff);
    register_spell_script(spell_spoils_throw_bomb);
    register_spell_script(spell_spoils_set_to_blow);
    register_spell_script(spell_spoils_armageddon_defense_system);
    register_aura_script(spell_spoils_nova);
    register_spell_script(spell_spoils_spark_of_life_missle);
    register_spell_script(spell_spoils_crimson_reconstruction_selector);
    register_aura_script(spell_matter_scramble);
    register_spell_script(spell_spoils_matter_scramble_check);
    register_aura_script(spell_spoils_torment);
    register_spell_script(spell_spoils_mogu_warlord_jade_tempest);
    register_aura_script(spell_spoils_unstable_defense_system_alt_power);
    register_aura_script(spell_spoils_eminence);
    register_aura_script(spell_spoils_gusting_crane_kick);
    register_spell_script(spell_spoils_path_of_blossoms);
    register_spell_script(spell_spoils_mantid_swarm_summon_right);
    register_spell_script(spell_spoils_mantid_swarm_summon_left);
    register_spell_script(spell_spoils_return_to_stone_eff);
    register_spell_script(spell_spoils_harden_flesh);
    register_aura_script(spell_spoils_blade_of_hundred_steps);
    register_aura_script(spell_spoils_strength_of_the_stone);
    register_aura_script(spell_spoils_unstable_defense_system_periodic);
    register_spell_script(spell_spoils_unstable_spark_missle);
    register_spell_script(spell_spoils_supernova);
    register_spell_script(spell_spoils_torment_link);
