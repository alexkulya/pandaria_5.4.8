...
void AddSC_iron_juggernaut()
{
    ...
    register_creature_script(npc_crawler_mine);
    register_creature_script(npc_borer_drill);
    register_creature_script(npc_juggernaut_explosive_tar);
    register_creature_script(npc_juggernaut_cutter_laser);
    register_creature_script(npc_juggernaut_crawler_mine_clicker);
    register_creature_script(npc_juggernaut_sawblade);

    register_spell_script(spell_juggernaut_scatter_laser_init);
    register_aura_script(spell_juggernaut_laser_strike);
    register_spell_script(spell_juggernaut_scatter_laser_selector);
    register_spell_script(spell_juggernaut_mortar_blast_selector);
    register_spell_script(spell_juggernaut_crawler_mine_selector);
    register_spell_script(spell_juggernaut_mortar_blast_init);
    register_spell_script(spell_juggernaut_cutter_laser_init);
    register_spell_script(spell_juggernaut_borer_drill_selector);
    register_spell_script(spell_juggernaut_demolisher_cannons_selector);
    register_aura_script(spell_juggernaut_explosive_tar);
    register_spell_script(spell_juggernaut_cutter_laser_script);
    register_spell_script(spell_juggernaut_cutter_laser_selector);
    register_aura_script(spell_juggernaut_detonation_sequence);
    register_spell_script(spell_juggernaut_explosive_tar_summon);
    register_spell_script(spell_juggernaut_ricochet_launch);
    register_aura_script(spell_juggernaut_ricochet_transform);
    register_spell_script(spell_juggernaut_ricochet_remove);
    register_spell_script(spell_juggernaut_mortar_barrage_launcher);
    register_aura_script(spell_juggernaut_mortar_barrage_triggering);
    register_spell_script(spell_juggernaut_seismic_activity_eff);
    register_spell_script(spell_juggernaut_shock_pulse);
