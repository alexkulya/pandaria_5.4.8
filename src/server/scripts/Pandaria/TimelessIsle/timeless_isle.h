...
enum TimelessIsleFactions
{
    FACTION_FRIENDLY                        = 35,
    FACTION_HOSTILE_NEUTRAL                 = 31
};

enum TimelessIsleCreaturesSpellData
{
    // Turtles
...
enum TimelessIsleGameObjects
{
    GO_CELESTIAL_DOOR                       = 223501,
    GO_HEATET_DOOR                          = 221032
};

enum TimelessIsleEmperorActions
{
    ACTION_XUEN                             = 1,
    ACTION_CHIJI                            = 2,
    ACTION_NIUZAO                           = 3,
...
enum TimelessIsleEmprerorTexts
{
