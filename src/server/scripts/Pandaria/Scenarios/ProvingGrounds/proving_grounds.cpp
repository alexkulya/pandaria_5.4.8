...
{
    register_creature_script(npc_proving_grounds_base);
    register_creature_script(npc_proving_grounds_illusionary_guardian);
    register_creature_script(npc_proving_grounds_illusionary_amber_weaver);
    register_creature_script(npc_proving_grounds_illusionary_mystic);
    register_creature_script(npc_proving_grounds_illusionary_banana_tosser);
    register_creature_script(npc_proving_grounds_illusionary_banshe);
    register_creature_script(npc_proving_grounds_illusionary_sha);
    register_creature_script(npc_proving_grounds_illusionary_forager);
    register_creature_script(npc_proving_grounds_illusionary_flamecaller);
    register_creature_script(npc_proving_grounds_illusionary_wind_guard);
    register_creature_script(npc_proving_grounds_illusionary_ambusher);
    register_creature_script(npc_proving_grounds_illusionary_conqueror);
    register_creature_script(npc_proving_grounds_illusionary_hive_singer);
    register_creature_script(npc_proving_grounds_illusionary_flamecaller_healer);
    register_creature_script(npc_proving_grounds_illusionary_aqualyte);
    register_creature_script(npc_proving_grounds_illusionary_tunneler);
    register_creature_script(npc_proving_grounds_illusionary_conqueror_healer);
    register_creature_script(npc_proving_grounds_kavan_the_arcanist);
    register_creature_script(npc_proving_grounds_ki_the_assassin);
    register_creature_script(npc_proving_grounds_oto_the_protector);
    register_creature_script(npc_proving_grounds_sooli_the_survivalist);
    new npc_proving_grounds_trial_master_rotun();
    register_creature_script(npc_proving_grounds_controller);
    register_creature_script(npc_proving_grounds_sikari_the_mistweaver);
    new npc_proving_grounds_trial_master_rotun_queue();
    register_creature_script(npc_proving_grounds_berserking);

    register_spell_script(spell_proving_grounds_bananastorm_selector);
    register_aura_script(spell_proving_grounds_banshe_timer);
    register_spell_script(spell_proving_grounds_amber_globule_detonation);
    register_aura_script(spell_proving_grounds_protection_shield);
    register_aura_script(spell_proving_grounds_exposed);
    register_aura_script(spell_proving_grounds_aqua_bomb);
    register_aura_script(spell_proving_grounds_renewing_mist);
    register_spell_script(spell_proving_grounds_wing_blast);
    register_aura_script(spell_proving_grounds_chomp);
