...
void AddSC_scenario_isle_of_thunder()
{
    ...
    register_creature_script(npc_shaolmara_player_covenant_hippogryph);
    register_creature_script(npc_shaolmara_covenant_hippogryph);
    register_creature_script(npc_shaolmara_vereesa_windrunner);
    register_creature_script(npc_shaolmara_beastcaller);
    register_creature_script(npc_shaolmara_raptor);
    register_creature_script(npc_arcanital_marakah);
    register_creature_script(npc_shaolmara_anki);
    register_creature_script(npc_shaolmara_beastcaller_pakutesh);
    register_creature_script(npc_shaolmara_zebtula_stoneshield);
    register_creature_script(npc_shaolmara_zandalari_barricade);
    new npc_zebtula_lorthemar_theron();
    register_creature_script(npc_zebtula_player_bloodhawk);
    register_creature_script(npc_zebtula_bloodhawk);
    register_creature_script(npc_zebtula_scout_captain_elsia);
    register_creature_script(npc_arcanital_tulachek);
    register_creature_script(npc_zebtula_kresh_the_reaper);
    new npc_teardown_scout_captain_elsia();
    register_creature_script(npc_teardown_heavy_explosives);
    register_creature_script(npc_teardown_lorthemar_therone);
    register_creature_script(npc_wargod_alchukla);
    register_creature_script(npc_teardown_zandalari_bloodguard);
    register_creature_script(npc_teardown_spirit_void_sentry);
    register_creature_script(npc_teardown_zandalari_soultwister);
    register_creature_script(npc_teardown_zandalari_haruspex);
    register_creature_script(npc_teardown_covenant_leader);
    register_creature_script(npc_slavemaster_shiaxu);
    register_creature_script(npc_shanze_electrocutioner);
    register_creature_script(npc_in_sky_lightning_strike_dummy);
    register_creature_script(npc_shanze_slaver);
    register_creature_script(npc_beastmaster_horaki);
    register_creature_script(npc_lorthemar_therone_to_skies);
    register_creature_script(npc_scout_captain_elsia_to_skies);
    register_creature_script(npc_thunderwing_to_skies);
    register_creature_script(npc_zandalari_pterrorwing_to_skies);
    register_creature_script(npc_zandlari_beastcaller_to_skies);
    new npc_taoshi_to_skies();
    register_creature_script(npc_taoshi_stormsea_landing);
    register_creature_script(npc_thunderwing_stormsea_landing);
    register_creature_script(npc_taoshi_stormsea_landing_ship);
    register_creature_script(npc_captain_halukal);
    register_creature_script(npc_drunken_wingrider);
    register_creature_script(npc_veteran_wingrider);
    register_creature_script(npc_zandalari_golem);
    register_creature_script(npc_zandalari_spirit_twister);
    register_creature_script(npc_huseng_gatekeeper);
    new npc_stormsea_landing_taoshi_queue();
    register_creature_script(npc_stormsea_landing_sentry_totem);
    register_creature_script(npc_stormsea_landing_sentry_beam_bunny);
    register_creature_script(npc_stormsea_landing_zandalari_pterrorwing);
    register_creature_script(npc_shanbu_assault_base);
    new npc_shanbu_fall_elsia();
    register_creature_script(npc_shanbu_palace_gatekeeper);
    register_creature_script(npc_shanbu_shanze_electrocutioner);
    register_creature_script(npc_shanbu_quilen_guardian);
    register_creature_script(npc_shan_bu);
    register_creature_script(npc_shanbu_nalak);
    new npc_wrathion_thunder_forge();
    register_creature_script(npc_thunder_forge_shado_pan_warrior);
    register_creature_script(npc_thunder_forge_bunny);
    register_creature_script(npc_forgemaster_vulkon);
    register_creature_script(npc_thunder_forge_shanze_warrior);
    register_creature_script(npc_thunder_forge_shanze_pyromancer);
    register_creature_script(npc_thunder_forge_second_bunny);
    register_creature_script(npc_thunder_forge_sha_fiend);
    register_creature_script(npc_sha_almagmation);
    register_creature_script(npc_thunder_forge_celestial_defender);
    register_creature_script(npc_thunder_forge_celestial_blacksmith);
    new go_teardown_heavy_explosives();
    new go_thunder_forge_mogu_crucible();
    new go_thunder_forge_anvil();

    register_spell_script(spell_shaolmara_lightning_strike);
    register_aura_script(spell_teardown_legacy_of_blood);
    register_spell_script(spell_in_sky_lightning_charge);
    register_aura_script(spell_in_sky_electrified_chains);
    register_spell_script(spell_jump_on_pterrorwing);
    register_spell_script(spell_stormsea_landing_smoke_bomb_deactivated);
    register_aura_script(spell_stormsea_landing_mark_of_taoshi_eff);
    register_spell_script(spell_stormsea_landing_infiltrating_eff);
    register_spell_script(spell_stormsea_landing_gatekeepers_orb);
    register_aura_script(spell_thunder_forge_sha_cosmetic_spawn);
    register_spell_script(spell_thunder_forge_thunder_surge);
