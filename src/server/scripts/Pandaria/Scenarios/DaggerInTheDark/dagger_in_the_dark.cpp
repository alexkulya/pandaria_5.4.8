...
void AddSC_dagger_in_the_dark()
{
    ...
    register_creature_script(npc_dagger_in_dark_grizzle_gearslip);
    register_creature_script(npc_dagger_in_dark_mogu_rune);
    register_creature_script(npc_dagger_in_dark_darkhatched_shaman);
    register_creature_script(npc_dagger_in_dark_darkhatched_skulker);
    register_creature_script(npc_dagger_in_dark_darkhatched_skinflayer);
    register_creature_script(npc_dagger_in_dark_broodmaster_noshi);
    register_creature_script(npc_dagger_in_dark_stalactite);
    register_creature_script(npc_dagger_in_dark_corrupted_dark_hatched_egg);
    register_creature_script(npc_dagger_in_dark_corrupted_darkhatched_slayer);
    register_creature_script(npc_dagger_in_dark_darkhatched_oracle);
    register_creature_script(npc_dagger_in_dark_darkhatched_flesh_hunter);
    register_creature_script(npc_dagger_in_dark_darkhatched_lizard_lord);
    register_creature_script(npc_dagger_in_dark_spring_saurok_slayer);
    register_creature_script(npc_dagger_in_dark_rakgor_bloodrazor);
    register_creature_script(npc_dagger_in_dark_broken_mogu_tablet);
    register_creature_script(npc_dagger_in_dark_goblin_cannon);
    
    register_spell_script(spell_dagger_in_dark_shadowstep_selector);
    register_spell_script(spell_dagger_in_dark_shadowstep_eff);
    register_spell_script(spell_dagger_in_dark_hatch_selector);
    register_aura_script(spell_dagger_in_dark_hatch_eff);
    register_spell_script(spell_dagger_in_dark_death_nova);
    register_spell_script(spell_dagger_in_dark_water_jets);
    register_aura_script(spell_dagger_in_dark_stasis);
    register_spell_script(spell_dagger_in_dark_investigation);
