...
void AddSC_jade_forest()
{
    ...
    new npc_big_bao();
    register_creature_script(npc_silverhorn_stag);
    register_creature_script(npc_forest_huntress);
    register_creature_script(npc_greenstone_nibbler);
    register_creature_script(npc_greenstone_gorger);
    register_creature_script(npc_greenwood_thief);
    register_creature_script(npc_ivory_starling);
    register_creature_script(npc_greenwood_trickster);
    register_creature_script(npc_brittle_greenstone_gorger);
    register_creature_script(npc_shade_of_ling_heartfist);
    register_creature_script(npc_jade_guardian);
    register_creature_script(npc_subjugator_gormal);
    register_creature_script(npc_orchard_wasp);
    register_creature_script(npc_ink_tipped_crane);
    register_creature_script(npc_crane_hunter);
    register_creature_script(npc_morgrinn_crackfang);
    register_creature_script(npc_shanze_spiritclaw);
    register_creature_script(npc_urobi_the_walker);
    register_creature_script(npc_siftworm);
    register_creature_script(npc_honeykeeper);
    register_creature_script(npc_final_doubt);
    register_creature_script(npc_nurse_shark);
    register_creature_script(npc_slitherscale_lizard_lord);
    register_creature_script(npc_shadowfae_trickster);
    register_creature_script(npc_thunderfist_gorilla);
    // Quest scripts
    new npc_nectarbreeze_farmer();
    register_creature_script(npc_windward_hatchling);
    register_creature_script(npc_windward_nest_trigger);
    ...
    register_creature_script(npc_sam_the_wise);
    register_creature_script(npc_plight_general_bunny);
    register_creature_script(npc_jade_forest_boiling_cauldron);
    register_creature_script(npc_jf_wild_prowler);
    register_creature_script(npc_jf_wild_stalker);
    new npc_lorewalker_cho_stones_could_speak();
    register_creature_script(npc_lorewalker_cho_peering_into_past);
    new npc_prince_anduin_decision_questgiver();
    register_creature_script(npc_prince_anduin_decision);
    register_creature_script(npc_prince_anduin_decision_helpers);
    new go_jade_forest_keg_of_metal_brew();
    register_spell_script(spell_jade_forest_smoked_blade);
    register_spell_script(spell_jade_forest_summon_metal_brewmaster);
    register_spell_script(spell_summon_boiling_cauldron);
    register_aura_script(spell_cho_teapot_master);
    register_spell_script(spell_jade_forest_lorewalker_cho_monolith);
    ...
    register_creature_script(npc_jade_forest_alliance_barricade);
    register_spell_script(spell_jade_forest_mouthwatering_brew_launcher);
    register_spell_script(spell_jade_forest_nazgrims_flare_gun);
    register_creature_script(npc_jade_forest_playful_colored_serpent);
    new scene_jade_forest_jade_serpent();
    register_creature_script(npc_jade_forest_instant_message_camera_bunny);
    register_aura_script(spell_jade_forest_signal_flare_initialize);
    register_spell_script(spell_reverse_cast_ride_seat_1);
}
