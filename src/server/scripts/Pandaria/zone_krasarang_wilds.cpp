...
void AddSC_krasarang_wilds()
{
    ...
    register_creature_script(npc_shieldwall_footman);
    register_creature_script(npc_krasari_tormentor);
    register_creature_script(npc_krasari_runekeeper);
    register_creature_script(npc_weeping_horror);
    register_creature_script(npc_bilgewater_sapper);
    register_creature_script(npc_viceclaw_scuttler);
    register_creature_script(npc_dominance_grunt);
    register_creature_script(npc_elder_seadragon);
    register_creature_script(npc_sunwalker_scout);
    register_creature_script(npc_dojani_dominator);
    register_creature_script(npc_dojani_enforcer);
    register_creature_script(npc_dojani_surveyor);
    register_creature_script(npc_dojani_reclaimer);
    register_creature_script(npc_riverblade_slayer);
    register_creature_script(npc_sha_of_despair);
    register_creature_script(npc_echo_of_despair);
    register_creature_script(npc_source_of_despair);
    register_creature_script(npc_child_of_chi_ji_krasarang);
    register_creature_script(npc_student_of_chi_ji);
    register_creature_script(npc_alliance_landing_boat);
    register_creature_script(npc_varian_wrynn_krasarang_landing);
    register_creature_script(npc_hilda_hornswaggle_krasarang_landing);
    register_creature_script(npc_horde_landing_boat);
    register_creature_script(npc_garrosh_hellscream_krasarang_landing);
    register_creature_script(npc_stoneplow_envoy);
    register_creature_script(npc_nahassa);
    register_creature_script(npc_high_marshal_twinbraid);
    register_creature_script(npc_warlord_bloodhilt);
    new npc_krasarang_wilds_lyalia();
    register_creature_script(npc_groundbreaker_brojai);
    register_creature_script(npc_krasarang_wilds_sunwalker_dezco_reclaimer);
    register_creature_script(npc_lorewalker_cho_wanderers_festival);
    new go_mysterious_whirlpool();
    register_spell_script(spell_call_of_despair_target_picker);
    register_spell_script(spell_call_of_despair_missle);
    register_aura_script(spell_krasarang_landing_cinematic);
    register_aura_script(spell_chaingun);
    register_aura_script(spell_cannonball_spin);
    register_spell_script(spell_bloodhilt_brutal_charge);
    new atrigger_script<sat_gift_of_chi_ji>("sat_gift_of_chi_ji");
    new at_the_arcanic_oubliette();
    register_creature_script(npc_frenzied_reef_shark);
    register_creature_script(npc_na_lek);
    register_creature_script(npc_the_bell_peaks_start);
    register_creature_script(npc_lorekeeper_vaeldrin);
}
