...
void AddSC_the_veiled_stair()
{
    ...
    register_creature_script(npc_darkhatched_soulbleeder);
    register_creature_script(npc_leechfingers);
    register_creature_script(npc_hatescale_spitter);
    register_creature_script(npc_hatescale_ironface);
    new npc_wrathion_thunder_king();
    register_creature_script(npc_image_of_wrathion);
    register_creature_script(npc_wrathion_suen_celestial);
    register_creature_script(npc_wrathion_chiji_celestial);
    register_creature_script(npc_wrathion_niuzao_celestial);
    new npc_wrathion_yulon_celestial();
    register_creature_script(npc_wrathion_xuen_challenge);
    register_creature_script(npc_neltharions_tear);
    register_creature_script(npc_xuen_challenge_gong);
    register_creature_script(npc_wrathion_cloak_achieve);
    new npc_wrathion_at_massons_folly();
    register_creature_script(npc_wrathion_celestial_spirits_cloak);
    new npc_wrathion_pandaren_legend();
    register_creature_script(npc_willy_wilder);

    register_spell_script(spell_wrathion_holding_a_cup);
    register_aura_script(spell_summon_wrathion_celestials);
    register_aura_script(spell_wrathion_reign_of_fire);
    register_spell_script(spell_wrathion_blindside);
    register_aura_script(spell_wrathion_legendary_finale);
    register_spell_script(spell_legendary_wrathion_essence);
    register_aura_script(spell_violets_and_blueberries);
