...
{
    register_creature_script(npc_nessos_the_oracle);
    register_creature_script(npc_ski_thik);
    register_creature_script(npc_mogujia_soul_caller);
    register_creature_script(npc_quilen_stonemaw);
    register_creature_script(npc_zai_the_outcast);
    register_creature_script(npc_terracotta_gladiator);
    register_creature_script(npc_terracotta_defender);
    register_creature_script(npc_upland_raven);
    register_creature_script(npc_zandalari_warrior);
    register_creature_script(npc_hungry_yeti);
    register_creature_script(npc_mischievous_snow_sprite);
    register_creature_script(npc_tomb_guardian);
    // Quest scripts
    new npc_waterspeaker_gorai();
    register_creature_script(npc_ordo_overseer);
    new go_yaungol_banner();
    register_creature_script(npc_explosives_barrel);
    new npc_inkgill_dissenter();
    new npc_shado_pan_sentinel();
    new npc_lorewalker_cho_bashon();
    register_creature_script(npc_lorewalker_cho_bashon_summoned);
    register_creature_script(npc_relcaimer_zuan_pets);
    new npc_master_hight();
    register_creature_script(npc_initiate_chuang_summoned);
    new npc_xuen_celestial_experience();
    register_creature_script(celestial_experience_sha);
    register_creature_script(npc_varatus_the_conqueror);
    register_aura_script(spell_summ_lorewalker_cho_bashon);
    register_aura_script(spell_celestial_experience_whirlwind_of_anger);
    register_spell_script(spell_celestial_experience_devastation);
    new scene_memory_wine();
    register_creature_script(npc_kota_kon);
    register_creature_script(npc_korda_torros);
    register_creature_script(npc_borginn_darkfist);
    register_creature_script(npc_scritch);
    register_creature_script(npc_the_yowler);
    register_creature_script(npc_kun_lai_grandpa_grumplefloot);
    register_spell_script(spell_kunlai_release_old_poot_poot);
    register_creature_script(npc_kunlai_old_poof_poof);
    register_creature_script(npc_ooking_shaman);
    register_creature_script(npc_silverback_piker);
    register_creature_script(npc_broketooth_leaper);
}
