...
void AddSC_isle_of_thunder()
{
    ...
    new npc_mumta();
    register_creature_script(npc_thunder_pterodactyls);
    new npc_progenitus();
    new npc_goda();
    ...
    new npc_molthor();
    new npc_rasha();
    register_creature_script(npc_thunder_zandalaris);
    new npc_spirit_of_warlord_teng();
    register_creature_script(npc_shanze_bloodseeker);
    register_creature_script(npc_horgak_the_enslaver);
    register_creature_script(npc_animated_warrior);
    register_creature_script(npc_lightning_rod);
    register_creature_script(npc_electromancer_jule);
    register_creature_script(npc_creeping_moor_beast);
    register_creature_script(npc_slateshell_wanderer);
    register_creature_script(npc_drakkari_god_hulk);
    register_creature_script(npc_zandalari_colossus);
    register_creature_script(npc_wave_of_might);
    register_creature_script(npc_zandalari_stoneshield);
    register_creature_script(npc_zandalari_beastcaller);
    register_creature_script(npc_juvenile_skyscreamer);
    register_creature_script(npc_zandalari_spiritbinder);
    register_creature_script(npc_zandalari_arcweaver);
    register_creature_script(npc_zandalari_jaguar_warrior);
    register_creature_script(npc_shanze_thundercaller);
    register_creature_script(npc_shanze_gravekeeper);
    register_creature_script(npc_sparkmancer_vu);
    register_creature_script(npc_shanze_soulripper);
    register_creature_script(npc_ancient_stone_conqueror);
    register_creature_script(npc_slateshell_ancient);
    register_creature_script(npc_tamed_bladetalon);
    register_creature_script(npc_zandalari_beastlord);
    register_creature_script(npc_skumblade_skirmisher);
    register_creature_script(npc_skumblade_brute);
    register_creature_script(npc_skumblade_flithmonger);
    register_creature_script(npc_skeletal_lasher);
    new npc_scout_captain_elsia();
    register_creature_script(npc_sunreaver_bloodhawk);
    new npc_vereesa_windrunner();
    register_creature_script(npc_silver_covenant_hippogryph);
    register_creature_script(npc_lorthemar_theron_isle_intro);
    register_creature_script(npc_aethas_isle_intro);
    register_creature_script(npc_stone_ritual_bunny_controller);
    register_creature_script(npc_guardian_taku);
    register_creature_script(npc_master_caller);
    register_creature_script(npc_puzzle_controller_bunny);
    register_creature_script(npc_incompleted_drakari_colossus);
    new npc_iot_taran_zhu();
    register_creature_script(npc_iot_stone_sentinel);
    new npc_assigment_map();
    register_creature_script(npc_nalak_essence_of_storms);
    register_creature_script(npc_fleshcrafter_hoku);
    register_creature_script(npc_metal_lord_meno_han);
    register_creature_script(npc_hatchling_skyscreamer);
    register_creature_script(npc_ingaluk_roach);
    register_creature_script(npc_zandalari_beastcaller_passenger);

    new spell_incantation_of_gura();
    register_spell_script(spell_reverberating_smash);
    register_spell_script(spell_reverberating_smash_wave);
    register_spell_script(spell_lightning_crack);
    register_aura_script(spell_lightning_crack_visual);
    register_aura_script(spell_alert_drumbs);
    register_spell_script(spell_zandalari_potion);
    register_aura_script(spell_shellwind);
    register_spell_script(spell_pounce_jump);
    register_spell_script(spell_preform_ritual);
    register_aura_script(spell_teleport_to_thunder_isle_horde);
    register_aura_script(spell_teleport_to_thunder_isle_alliance);
    register_aura_script(spell_summon_lorthemar_isle_intro);
    register_spell_script(spell_plant_mogu_weapon);
    register_spell_script(spell_mummy_burn_corpse);
    register_aura_script(spell_resonanse_siphon);
    register_spell_script(spell_mogu_manipulation);
    register_spell_script(spell_mogu_manipulation_cancel);
    register_spell_script(spell_iot_lightning_charge);
    register_aura_script(spell_embedded_spear);
    register_spell_script(spell_nalak_throw_spear);
    register_spell_script(spell_summon_essence_of_storm);
    register_spell_script(spell_nalak_empower_lightning_lance);
    register_spell_script(spell_hoku_exsanguination);
    register_spell_script(spell_mono_han_toss_energized_metal_targeting);
    register_aura_script(spell_power_surge_achiev);
