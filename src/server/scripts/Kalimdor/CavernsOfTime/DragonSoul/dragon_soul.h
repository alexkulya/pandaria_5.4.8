...
enum Worldstates
{
    WORLDSTATE_DONT_STAND_SO_CLOSE_TO_ME = 10018,
    WORLDSTATE_PING_PONG_CHAMPION        = 9880,
    WORLDSTATE_TASTE_THE_RAINBOW_BY      = 9881,
    WORLDSTATE_TASTE_THE_RAINBOW_RG      = 9882,
    WORLDSTATE_TASTE_THE_RAINBOW_BB      = 9883,
    WORLDSTATE_TASTE_THE_RAINBOW_PY      = 9884,
    WORLDSTATE_HOLDING_HANDS             = 9987,
    WORLDSTATE_MINUTES_TO_MIDNIGHT       = 9667,
    WORLDSTATE_DECK_DEFENDER             = 9828,
    WORLDSTATE_MAYBE_HE_WILL_GET_DIZZY   = 9917,
    WORLDSTATE_CHROMATIC_SHAMPION_A      = 9992,
    WORLDSTATE_CHROMATIC_SHAMPION_K      = 9995,
    WORLDSTATE_CHROMATIC_SHAMPION_N      = 9993,
    WORLDSTATE_CHROMATIC_SHAMPION_Y      = 9994,
};
