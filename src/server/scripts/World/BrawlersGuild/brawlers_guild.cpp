...
{
    register_creature_script(npc_brawlers_guild_bizmo);
    new npc_brawlers_guild_brawlgar_arena_grunt();
    register_creature_script(npc_brawlers_guild_boss_bazzelflange);

    register_creature_script(npc_brawlers_guild_bruce);
    register_creature_script(npc_brawlers_guild_vian_the_volatile);
    register_creature_script(npc_brawlers_guild_volatile_flame);
    register_creature_script(npc_brawlers_guild_fire_line);
    register_creature_script(npc_brawlers_guild_goredome);
    register_creature_script(npc_brawlers_guild_dungeon_master_vishas);
    register_creature_script(npc_brawlers_guild_dippy);
    register_creature_script(npc_brawlers_guild_kirrawk);
    register_creature_script(npc_brawlers_guild_twister);
    register_creature_script(npc_brawlers_guild_fran);
    register_creature_script(npc_brawlers_guild_riddoh);
    register_creature_script(npc_brawlers_guild_goblin_land_mine);
    register_creature_script(npc_brawlers_guild_king_kulaka);
    register_creature_script(npc_brawlers_guild_blat);
    register_creature_script(npc_brawlers_guild_sanoriak);
    register_creature_script(npc_brawlers_guild_ixx);
    register_creature_script(npc_brawlers_guild_mazhareen);
    register_creature_script(npc_brawlers_guild_crush);
    register_creature_script(npc_brawlers_guild_leona_earthwind);
    register_creature_script(npc_brawlers_guild_dominika_the_illusionist);
    register_creature_script(npc_brawlers_guild_dominika_illusion);
    register_creature_script(npc_brawlers_guild_deeken);
    register_creature_script(npc_brawlers_shock_field);
    register_creature_script(npc_brawlers_guild_millie_watt);
    register_creature_script(npc_brawlers_guild_fjoll);
    register_creature_script(npc_brawlers_guild_proboskus);
    register_creature_script(npc_brawlers_guild_lepregnomes);
    register_creature_script(npc_brawlers_guild_yikkan_izu);
    register_creature_script(npc_brawlers_guild_izus_raven);
    register_creature_script(npc_brawlers_guild_akama);
    register_creature_script(npc_brawlers_guild_smash_hoofstomp);
    register_creature_script(npc_brawlers_guild_good_luck_goblin);
    register_creature_script(npc_brawlers_guild_unguloxx);
    register_creature_script(npc_brawlers_guild_gg_ingeenering);
    register_creature_script(npc_brawlers_guild_dark_summoner);
    register_creature_script(npc_brawlers_guild_tormented_ghost);
    register_creature_script(npc_brawlers_guild_battletron);
    register_creature_script(npc_brawlers_guild_unstable_mine);
    register_creature_script(npc_brawlers_guild_meatball);
    register_creature_script(npc_brawlers_guild_mecha_bruce);
    register_creature_script(npc_brawlers_guild_grandpa_grumplefloot);
    register_creature_script(npc_brawlers_guild_blingtron_3000);
    register_creature_script(npc_brawlers_guild_gnomish_tesla_coil);
    register_creature_script(npc_brawlers_guild_blingtron_2000);
    new npc_brawlers_guild_card_traider();

    register_aura_script(spell_brawlers_guild_join_to_arena);
    register_spell_script(spell_brawlers_guild_fire_line);
    register_aura_script(spell_brawlers_guild_lumbering_charge);
    register_spell_script(spell_brawlers_guild_twister_aura);
    register_spell_script(spell_brawlers_guild_goblin_land_mines);
    register_spell_script(spell_brawlers_guild_devastating_thrust);
    register_spell_script(spell_brawlers_guild_illusionist);
    register_spell_script(spell_brawlers_guild_rain_dance);
    register_spell_script(spell_brawlers_guild_fallen_kin);
    register_spell_script(spell_brawlers_guild_emergency_teleport);
    register_aura_script(spell_brawlers_guild_energy_shielding);
    register_aura_script(spell_brawlers_guild_goblin_rocket_barrage);
    register_aura_script(spell_brawlers_guild_conjure_unstable_mines);
    register_aura_script(spell_brawlers_guild_protected_by_unstable_mines);
    register_spell_script(spell_brawlers_guild_ring_of_valor_teleport_in);
    register_spell_script(spell_brawlers_guild_flamewall);
    register_aura_script(spell_brawlers_guild_rageful_spirit);
    register_aura_script(spell_brawlers_guild_dark_barrage);
    register_spell_script(spell_brawlers_guild_angry_enthusiast_selector);
    register_spell_script(spell_brawlers_guild_bottled);
    register_spell_script(spell_brawlers_guild_summon_ghost);
    register_spell_script(spell_brawlers_guild_better_stronger_faster);
    register_spell_script(spell_brawlers_guild_luckydo_nt_launcher);
    register_spell_script(spell_brawlers_guild_overcharged);
    register_aura_script(spell_brawlers_guild_overcharged_aura);
    register_spell_script(spell_brawlers_guild_chain_lightning_visual);
    register_spell_script(spell_brawlers_guild_overcharging_tesla_coil);
