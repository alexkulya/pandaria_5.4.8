...
void AddSC_npcs_special()
{
    ...
    register_creature_script(npc_stone_statue);
    register_creature_script(npc_sky_lantern);
    new npc_pandaria_treasures();
    new npc_steam_powered_auctioneer();
    register_creature_script(npc_visual_sparring);
    register_creature_script(npc_abominated_greench);
    register_creature_script(npc_anatomical_dummy);
    register_creature_script(npc_soul_mirror_artifact);
    register_creature_script(npc_vision_of_the_naaru_stalker);
    register_creature_script(npc_vision_of_the_naaru);
    register_creature_script(npc_sword_dancers_stalker);
    register_creature_script(npc_sword_dancer);
    register_creature_script(npc_mini_mana_bomb);
    register_creature_script(npc_scourge_haunt);
    register_creature_script(npc_sylvanas_lamenter);
    register_creature_script(npc_ethereal_soul_trader);
    register_creature_script(npc_sa_demolisher);
    register_creature_script(npc_rogue_rare_npc);
    register_creature_script(npc_pandaren_firework_launcher);
}
