        ...
        void WaypointReached(uint32 waypointId) override
        {
            switch (waypointId)
            {
                ...
                case 3:
                {
                    ...
                    {
                        temp->SetWalk(true);
                        temp->HandleEmoteStateCommand(EMOTE_STATE_READY2H);
                ...
                if (uiPhase_timer <= diff)
                {
                    ...
                    switch (uiStep)
                    {
                        ...
                        case 33: // Darion supports to jump to lich king here
                            ...
                            JumpToNextStep(me->GetSplineDuration());
                            break;
                        ...
                        case 42: // Maxwell yells for attack
                            {
                                ...
                                if (fLichPositionX && fLichPositionY)
                                {
                                    ...
                                    temp->HandleEmoteStateCommand(EMOTE_STATE_ATTACK_UNARMED);
                                    temp->SetWalk(false);
                        ...
                        case 43: // They all got kicked
                            ...
                            if (Creature* temp = Unit::GetCreature(*me, uiMaxwellGUID))
                            {
                                temp->HandleEmoteStateCommand(EMOTE_ONESHOT_NONE);
                        ...
                        case 48: // Show the cleansing effect (dawn of light)
                            ...
                            me->SummonGameObject(GO_LIGHT_OF_DAWN, 2283.896f, -5287.914f, 83.066f, 0, { }, 30000);
                            if (Creature* temp = Unit::GetCreature(*me, uiTirionGUID))
                            {
...
{
    npc_patchwerk_death_knight_quests(Creature* creature) : ScriptedAI(creature) { }
