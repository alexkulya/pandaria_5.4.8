...
class boss_maloriak : public CreatureScript
{
    public:
                    ...
                    switch (eventId)
                    {
                        case EVENT_FIRE_PHASE:
                            ...
                            if (GameObject* go = me->FindNearestGameObject(203306, 300.0f))
                                me->CastSpell(go, SPELL_THROW_RED_BOTTLE_A, false);
                        ...
                        case EVENT_FROST_PHASE:
                            ...
                            EventFireSkills(false);
                            if (GameObject* go = me->FindNearestGameObject(203306, 300.0f))
                                me->CastSpell(go, SPELL_THROW_BLUE_BOTTLE_A, false);
                        ...
                        case EVENT_GREEN_PHASE:
                            ...
                            EventFrostSkills(false);
                            if (GameObject* go = me->FindNearestGameObject(203306, 300.0f))
                                me->CastSpell(go, SPELL_THROW_GREEN_BOTTLE_A, false);
        ...
        {
            return GetInstanceAI<boss_maloriakAI>(creature);
        }
};
...
class npc_maloriak_flash_freeze : public CreatureScript
{
    public:
        ...
        struct npc_maloriak_flash_freezeAI : public ScriptedAI
        {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_maloriak_flash_freezeAI>(creature);
        }
};
...
class npc_absolute_zero : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_absolute_zeroAI>(creature);
        }
};
...
class npc_magma_jet : public CreatureScript
{
    public:
        ...
        struct npc_magma_jetAI : public ScriptedAI
        {
            npc_magma_jetAI(Creature* creature) : ScriptedAI(creature)
            {
                creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
                creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                SetCombatMovement(false);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_magma_jetAI>(creature);
        }
};
...
class npc_magma_jet_summon : public CreatureScript
{
    public:
        ...
        struct npc_magma_jet_summonAI : public ScriptedAI
        {
            npc_magma_jet_summonAI(Creature* creature) : ScriptedAI(creature)
            {
                creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
                creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                SetCombatMovement(false);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_magma_jet_summonAI>(creature);
        }
};
...
class npc_aberration : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_aberrationAI>(creature);
        }
};
...
class npc_prime_subject : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_prime_subjectAI>(creature);
        }
};
...
class npc_vile_swill : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_vile_swillAI>(creature);
        }
};
