            ...
            void Summon(uint8 uiCase)
            {
                switch (uiCase)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        if (GameObject* go = me->SummonGameObject(183410, -533.140f, -105.322f, -156.016f, 0, { }, 1000))
                        {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        if (GameObject* go = me->SummonGameObject(183410, -542.199f, -96.854f, -155.790f, 0, { }, 1000))
                        {
                            GoSummonList.push_back(go->GetGUID());
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        if (GameObject* go = me->SummonGameObject(183410, -507.820f, -103.333f, -151.353f, 0, { }, 1000))
                        {
                            GoSummonList.push_back(go->GetGUID());
                            go->SetFlag(GAMEOBJECT_FIELD_FLAGS, GO_FLAG_NOT_SELECTABLE); //We can't use it!
                            Summon(5);
                        ...
                        break;
                    case 7:
                        if (GameObject* go = me->SummonGameObject(183410, -511.829f, -86.249f, -151.431f, 0, { }, 1000))
                        {
                            GoSummonList.push_back(go->GetGUID());
                            go->SetFlag(GAMEOBJECT_FIELD_FLAGS, GO_FLAG_NOT_SELECTABLE); //We can't use it!
                        }
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[17].GetPositionX(), SpawnPosition[17].GetPositionY(), SpawnPosition[17].GetPositionZ(), SpawnPosition[17].GetOrientation(), { }, 7200);
                        me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[18].GetPositionX(), SpawnPosition[18].GetPositionY(), SpawnPosition[18].GetPositionZ(), SpawnPosition[18].GetOrientation(), { }, 7200);
                        me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[19].GetPositionX(), SpawnPosition[19].GetPositionY(), SpawnPosition[19].GetPositionZ(), SpawnPosition[19].GetOrientation(), { }, 7200);
                        break;
                }
            }
    ...
    public:
        ...
        struct boss_grubbisAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                {
                    if (eventId == EVENT_STRIKE)
                    {
                        if (Unit* vict = me->GetVictim())
                            DoCast(vict, SPELL_STRIKE);
