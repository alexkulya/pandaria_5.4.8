...
class boss_feludius : public CreatureScript
{
    public:
        ...
        {
            return GetInstanceAI<boss_feludiusAI>(creature);
        }
...
class boss_ignacious : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<boss_ignaciousAI>(creature);
        }
};
...
class boss_arion : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<boss_arionAI>(creature);
        }
};
...
class boss_terrastra: public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<boss_terrastraAI>(creature);
        }
};
...
class boss_elementium_monstrosity : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<boss_elementium_monstrosityAI>(creature);
        }

        struct boss_elementium_monstrosityAI : public BossAI
        {
            boss_elementium_monstrosityAI(Creature* creature) : BossAI(creature, DATA_COUNCIL), summons(me)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
            ...
            {
                if (actionId == ACTION_ELEMENTARY_ACHIEV && ++singleIceLiquidCount > 1)
                    me->GetMap()->SetWorldState(WORLDSTATE_ELEMENTARY, 0);
            }
...
class npc_violent_cyclone : public CreatureScript
{
    public:
        ...
        {
            npc_violent_cycloneAI(Creature* creature) : ScriptedAI(creature)
            {
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_violent_cycloneAI>(creature);
        }
};
...
class npc_bt_gravity_well : public CreatureScript
{
    public:
        ...
        struct npc_bt_gravity_wellAI : public ScriptedAI
        {
            npc_bt_gravity_wellAI(Creature* creature) : ScriptedAI(creature)
            {
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_bt_gravity_wellAI>(creature);
        }
};
...
class npc_ignacious_inferno_leap : public CreatureScript
{
    public:
        ...
        {
            npc_ignacious_inferno_leapAI(Creature* creature) : ScriptedAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
            ...
            void UpdateAI(uint32 /*diff*/) override
            {
                if (!me->FindNearestCreature(NPC_INFERNO_RUSH, 5.0f))
                    if (Creature* pIgnacious = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_IGNACIOUS)))
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_ignacious_inferno_leapAI>(creature);
        }
};
...
class npc_ignacious_inferno_rush : public CreatureScript
{
    public:
        ...
        struct npc_ignacious_inferno_rushAI : public ScriptedAI
        {
            npc_ignacious_inferno_rushAI(Creature* creature) : ScriptedAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_ignacious_inferno_rushAI>(creature);
        }
};
...
class npc_feludius_water_bomb : public CreatureScript
{
    public:
        ...
        struct npc_feludius_water_bombAI : public ScriptedAI
        {
            npc_feludius_water_bombAI(Creature* creature) : ScriptedAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_feludius_water_bombAI>(creature);
        }
};
...
class npc_ignacious_flame_strike : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_ignacious_flame_strikeAI>(creature);
        }
};
...
class npc_liquid_ice : public CreatureScript
{
    public:
        ...
        {
            npc_liquid_iceAI(Creature* creature) : ScriptedAI(creature)
            {
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_liquid_iceAI>(creature);
        }
};
...
class npc_ascendant_council_plume_stalker : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_ascendant_council_plume_stalkerAI>(creature);
        }
};
...
class npc_eruption_target : public CreatureScript
{
    public:
        ...
        struct npc_eruption_targetAI : public ScriptedAI
        {
            npc_eruption_targetAI(Creature* creature) : ScriptedAI(creature)
            {
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_eruption_targetAI>(creature);
        }
};
        ...
        class spell_monstrosity_cryogenic_aura_AuraScript : public AuraScript
        {
            ...
            void OnPeriodic(AuraEffect const* /*aurEff*/)
            {
                ...
                if (GetCaster()->ToCreature())
                    GetCaster()->ToCreature()->AI()->DoAction(ACTION_ELEMENTARY_ACHIEV);
