    ...
    public:
        ...
        struct instance_uldaman_InstanceMapScript : public InstanceScript
        {
            ...
            void OnGameObjectCreate(GameObject* go) override
            {
                switch (go->GetEntry())
                {
                    ...
                    case GO_KEYSTONE:
                        ...
                        break;
                    case GO_ARCHAEDAS_ALTAR:
                        archaedasAltarGUID = go->GetGUID();
                        break;
                }
            }
            ...
            void OnCreatureCreate(Creature* creature) override
            {
                ...
                {
                    case NPC_RELIQUARY_DIGGER:
                        if (teamInInstance == ALLIANCE)
                            creature->UpdateEntry(NPC_EXPLORERS_LEAGUE_DIGGER, ALLIANCE);
                        break;
                    case NPC_AOREN_SUNGLOW:
                        if (teamInInstance == ALLIANCE)
                            creature->UpdateEntry(NPC_KAND_SANDSEEKER, ALLIANCE);
                        break;
                    case NPC_LIDIA_SUNGLOW:
                        if (teamInInstance == ALLIANCE)
                            creature->UpdateEntry(NPC_OLGA_RUNEWORN, ALLIANCE);
                        break;
                    case NPC_HIGH_EXAMINER_TAETHELAN:
                        if (teamInInstance == ALLIANCE)
                            creature->UpdateEntry(NPC_LEAD_PROSPECTOR_DURDIN, ALLIANCE);
                        break;
