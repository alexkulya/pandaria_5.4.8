...
void AddSC_warrior_spell_scripts()
{
    ...
    register_spell_script(spell_warr_shockwave);
    new spell_warr_bloodthirst();
    new spell_warr_last_stand();
    new spell_warr_thunder_clap();
    register_spell_script(spell_warr_charge);
    ...
    register_aura_script(spell_warr_taste_for_blood);
    register_aura_script(spell_warr_taste_for_blood_effect);
    register_spell_script(spell_warr_revenge);
    register_aura_script(spell_warr_strikes_of_opportunity);
    register_aura_script(spell_warr_bloodbath);
    register_aura_script(spell_warr_sudden_death);
    register_spell_script(spell_warr_victory_rush);
    register_spell_script(spell_warr_victory_rush_heal);
    register_spell_script(spell_warr_impending_victory);
    register_spell_script(spell_warr_intervene);
    register_aura_script(spell_warr_sword_and_board);
    register_spell_script(spell_warr_sword_and_board_buff);
    register_spell_script(spell_warr_dragon_roar);
    register_spell_script(spell_warr_heroic_leap);
    register_spell_script(spell_warr_heroic_leap_damage);
    register_aura_script(spell_warr_heroic_leap_landing_arua);
    register_spell_script(spell_warr_enrage_raging_blow);
    register_spell_script(spell_warr_raging_blow);
    register_aura_script(spell_warr_second_wind);
    register_aura_script(spell_warr_second_wind_regen);
    register_spell_script(spell_warr_shield_slam);
    register_spell_script(spell_warr_shattering_throw);
    register_spell_script(spell_warr_colossus_smash);
    register_spell_script(spell_warr_glyph_of_die_by_the_sword);
    register_spell_script(spell_warr_heroic_strike_one_hand);
    register_aura_script(spell_warr_meat_cleaver);
    register_spell_script(spell_warr_intimidating_shout);
    register_aura_script(spell_warr_glyph_of_rude_interruption);
    register_aura_script(spell_warr_deep_wounds_proc_driver);
    register_aura_script(spell_warr_deep_wounds);
    register_aura_script(spell_warr_glyph_of_bloody_healing);
    register_aura_script(spell_warr_glyph_of_bloody_healing_effect);
    register_aura_script(spell_warr_shield_visual);
    register_aura_script(spell_warr_berserker_stance_passive);
    register_aura_script(spell_warr_spell_reflection);
    register_aura_script(spell_warr_demoralizing_shout);
    register_aura_script(spell_warr_shield_barrier);
    register_aura_script(spell_warr_t16_dps_2p_bonus);
    register_aura_script(spell_warr_t16_dps_4p_bonus);
    register_aura_script(spell_warr_t16_protection_2p_bonus);
    register_aura_script(spell_warr_t16_protection_4p_bonus);
    register_aura_script(spell_warr_reckless_defence);
    register_aura_script(spell_warr_sweeping_strikes);
    register_aura_script(spell_warr_glyph_of_hamstring);
    register_aura_script(spell_warr_charge_drop_fire_periodic);
    register_spell_script(spell_warr_glyph_of_blazing_trail);
}
