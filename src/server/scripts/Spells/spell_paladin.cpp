...
void AddSC_paladin_spell_scripts()
{
    ...
    register_spell_script(spell_pal_shield_of_the_righteous);
    register_spell_script(spell_pal_tower_of_radiance);
    ...
    register_spell_script(spell_pal_crusader_strike);
    register_spell_script(spell_pal_seal_of_truth_hotfix);
    register_aura_script(spell_pal_censure_hotfix);
    new spell_pal_avenging_wrath();
    new spell_pal_glyph_of_double_jeopardy_judgment();
    new spell_pal_blessing();
    new spell_pal_guardian();
    register_spell_script(spell_pal_sword_of_light_damage_bonus_holy);
    register_spell_script(spell_pal_pursuit_of_justice);
    register_spell_script(spell_pal_judgment);
    register_spell_script(spell_pal_word_of_glory);
    register_spell_script(spell_pal_word_of_glory_heal);
    register_spell_script(spell_pal_harsh_word);
    register_spell_script(spell_pal_grand_crusader);
    register_spell_script(spell_pal_divine_purpose);
    register_spell_script(spell_pal_inquisition);
    register_spell_script(spell_pal_light_of_dawn);
    register_spell_script(spell_pal_execution_sentence);
    register_aura_script(spell_pal_execution_sentence_effect);
    register_aura_script(spell_pal_lights_hammer);
    register_aura_script(spell_pal_consecration);
    register_aura_script(spell_pal_ancient_healer);
    register_aura_script(spell_pal_daybreak_passive);
    register_aura_script(spell_pal_daybreak);
    register_spell_script(spell_pal_daybreak_heal);
    register_spell_script(spell_pal_eternal_flame);
    register_aura_script(spell_pal_mastery_hand_of_light);
    register_spell_script(spell_pal_holy_wrath);
    register_spell_script(spell_pal_exorcism);
    register_spell_script(spell_pal_exorcism_glyphed);
    register_aura_script(spell_pal_glyph_of_inquisition);
    register_spell_script(spell_pal_lay_on_hands);
    register_spell_script(spell_pal_glyph_of_hammer_of_the_righteous);
    register_aura_script(spell_pal_bastion_of_glory);
    register_spell_script(spell_pal_flash_of_light);
    register_spell_script(spell_pal_selfless_healer);
    register_aura_script(spell_pal_selfless_healer_ui);
    register_aura_script(spell_pal_glyph_of_protector_of_the_innocent);
    register_aura_script(spell_pal_mastery_illuminated_healing);
    register_spell_script(spell_pal_divine_shield);
    register_aura_script(spell_pal_beacon_of_light);
    register_aura_script(spell_pal_beacon_of_light_remove);
    register_aura_script(spell_pal_seal_of_insight);
    register_aura_script(spell_pal_ancient_crusader);
    register_aura_script(spell_pal_guardian_of_ancient_kings);
    register_creature_script(npc_guardian_of_ancient_kings);
    register_spell_script(spell_pal_pvp_p14_holy);
    register_aura_script(spell_pal_seal_of_justice);
    register_aura_script(spell_pal_avenging_wrath);
    register_aura_script(spell_pal_sanctified_wrath);
    register_aura_script(spell_pal_glyph_of_double_jeopardy);
    register_spell_script(spell_pal_glyph_of_double_jeopardy_judgment);
    register_spell_script(spell_pal_t15_retribution_4p_bonus);
    register_aura_script(spell_pal_t15_protection_4p_bonus);
    register_aura_script(spell_pal_t16_protection_2p_bonus);
    register_aura_script(spell_pal_t16_protection_4p_bonus);
    register_aura_script(spell_pal_seal_of_righteousness);
    register_spell_script(spell_pal_holy_prism);
    register_spell_script(spell_pal_holy_prism_effect);
    register_spell_script(spell_pal_art_of_war);
    register_spell_script(spell_pal_glyph_of_mounted_king);
    register_spell_script(spell_pal_glyph_of_mounted_king_filter);
    register_aura_script(spell_pal_divine_plea);
    register_aura_script(spell_pal_glyph_of_blessed_life);
    register_aura_script(spell_pal_censure_control_fix);
    register_aura_script(spell_pal_hand_of_sacrifice);
    register_aura_script(spell_pal_glyph_of_bladed_judgement);
}
