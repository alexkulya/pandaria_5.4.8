...
{
    register_aura_script(spell_gen_absorb0_hitlimit1);
    register_aura_script(spell_gen_adaptive_warding);
    register_aura_script(spell_gen_alchemist_stone);
    register_spell_script(spell_gen_allow_cast_from_item_only);
    register_aura_script(spell_gen_animal_blood);
    register_spell_script(spell_spawn_blood_pool);
    register_aura_script(spell_gen_aura_of_anger);
    register_aura_script(spell_gen_aura_service_uniform);
    register_aura_script(spell_gen_av_drekthar_presence);
    register_spell_script(spell_gen_bandage);
    register_spell_script(spell_gen_bonked);
    new spell_gen_break_shield("spell_gen_break_shield");
    new spell_gen_break_shield("spell_gen_tournament_counterattack");
    register_aura_script(spell_gen_burn_brutallus);
    register_spell_script(spell_gen_cannibalize);
    register_spell_script(spell_gen_chaos_blast);
    register_spell_script(spell_gen_clone);
    register_spell_script(spell_gen_clone_weapon);
    ...
    register_aura_script(spell_gen_gift_of_naaru);
    ...
    register_spell_script(spell_pvp_trinket_wotf_shared_cd);
    register_aura_script(spell_gen_turkey_marker);
    register_spell_script(spell_gen_upper_deck_create_foam_sword);
    ...
    register_spell_script(spell_gen_debug_move);
    register_spell_script(spell_gen_eye_of_the_black_prince);
    register_aura_script(spell_gen_the_doctor_is_in);
    register_spell_script(spell_gen_mobile_banking);
    register_aura_script(spell_gen_the_quick_and_the_dead);
    register_spell_script(spell_gen_mass_resurrection);
    register_spell_script(spell_gen_item_crafted_kill_credit);
    register_spell_script(spell_gen_profession_research);
    register_spell_script(spell_gen_jewelcrafting_research);
    register_spell_script(spell_gen_scroll_of_wisdom);
    register_spell_script(spell_gen_banquet_of_the_x);
    register_spell_script(spell_gen_pandaren_banquet);
    register_spell_script(spell_gen_noodle_cart);
    register_spell_script(spell_gen_noodle_cart_wave);
    register_aura_script(spell_gen_noodle_cart_visual);
    register_aura_script(spell_gen_noodle_soup);
    register_aura_script(spell_gen_ancient_knowledge);
    register_aura_script(spell_gen_heirloom_experience_bonus);
    register_spell_script(spell_gen_shadowmeld);
    register_spell_script(spell_gen_free_action_potion);
    register_spell_script(spell_gen_elixir_of_wandering_spirits);
    register_aura_script(spell_gen_lightning_strike_charges_trigger);
    register_aura_script(spell_gen_capacitance);
    register_aura_script(spell_gen_clearcasting_trigger);
    register_spell_script(spell_gen_leyaras_locket);
    register_spell_script(spell_throw_haunted_memento);
    register_spell_script(spell_item_sylvanas_music_box);
    register_aura_script(spell_gen_flesh_to_stone);
    register_spell_script(spell_gen_isle_of_thunder_beacon);
    register_spell_script(spell_gen_portal_to_isle_of_thunder);
    register_aura_script(spell_gen_cobo_cola);
    register_aura_script(spell_gen_inactive);
    register_aura_script(spell_gen_standing_at_attention);
    register_aura_script(spell_shadow_sight);
    register_aura_script(spell_gen_water_strider_water_walking);
    register_aura_script(spell_carrying_seaforium);
    register_aura_script(spell_gen_surgical_alterations);
    register_spell_script(spell_gen_deserter);
    register_spell_script(spell_gen_rocket_barrage);
}
