...
{
    register_spell_script(spell_monk_chi_wave);
    register_spell_script(spell_monk_chi_wave_bolt);
    register_spell_script(spell_monk_chi_wave_target_selector);
    new spell_monk_grapple_weapon();
    register_spell_script(spell_monk_transcendence_transfer);
    register_spell_script(spell_monk_transcendence);
    new spell_monk_item_s12_4p_mistweaver();
    register_spell_script(spell_monk_diffuse_magic);
    register_spell_script(spell_monk_zen_flight_check);
    register_aura_script(aura_monk_glyph_of_zen_flight);
    register_aura_script(spell_monk_touch_of_karma);
    register_spell_script(spell_monk_touch_of_karma_target);
    new spell_monk_path_of_blossom();
    register_aura_script(spell_monk_zen_sphere);
    new spell_monk_energizing_brew();
    new spell_monk_spear_hand_strike();
    new spell_monk_tigers_lust();
    register_spell_script(spell_monk_chi_torpedo);
    new atrigger_script<sat_monk_chi_torpedo>("sat_monk_chi_torpedo");
    new spell_monk_breath_of_fire();
    register_aura_script(spell_monk_disable_refresh);
    register_spell_script(spell_monk_disable);
    register_spell_script(spell_monk_zen_pilgrimage);
    register_spell_script(spell_monk_zen_pilgrimage_return);
    register_spell_script(spell_monk_blackout_kick);
    register_spell_script(spell_monk_legacy_of_the_emperor);
    register_spell_script(spell_monk_paralysis);
    register_aura_script(spell_monk_paralysis_break);
    register_spell_script(spell_monk_chi_brew);
    new atrigger_script<sat_monk_ring_of_peace>("sat_monk_ring_of_peace");
    register_aura_script(spell_monk_ring_of_peace_aura);
    register_aura_script(spell_monk_s_e_f_aura);
    register_spell_script(spell_monk_s_e_f);
    register_creature_script(npc_monk_s_e_f_spirit);
    register_spell_script(spell_monk_detox);
    register_spell_script(spell_monk_specific_damage);
    register_spell_script(spell_monk_keg_smash);
    register_spell_script(spell_monk_rising_sun_kick);
    register_aura_script(spell_monk_combo_breaker);
    register_aura_script(spell_stance_of_the_sturdy_ox);
    register_aura_script(spell_monk_stagger);
    register_aura_script(spell_monk_stagger_dummy);
    register_spell_script(spell_monk_purifying_brew);
    register_spell_script(spell_monk_expel_harm);
    register_spell_script(spell_monk_healing_sphere);
    new atrigger_script<sat_monk_healing_sphere>("sat_monk_healing_sphere");
    register_aura_script(spell_monk_gift_of_the_ox);
    register_spell_script(spell_monk_summon_gift_of_the_ox);
    new atrigger_script<sat_monk_gift_of_the_ox>("sat_monk_gift_of_the_ox");
    register_aura_script(spell_monk_fortifying_brew);
    register_aura_script(spell_monk_brewing_elusive_brew);
    register_aura_script(spell_monk_elusive_brew);
    register_aura_script(spell_monk_fists_of_fury);
    register_spell_script(spell_monk_fists_of_fury_damage);
    register_spell_script(spell_monk_fists_of_fury_stun);
    register_aura_script(spell_monk_adaptation);
    register_aura_script(spell_monk_crackling_jade_lightning_knockback);
    register_spell_script(spell_monk_spinning_fire_blossom);
    register_spell_script(spell_monk_spinning_fire_blossom_glyphed);
    register_aura_script(spell_monk_brewing_tigereye_brew);
    register_spell_script(spell_monk_tigereye_brew);
    register_aura_script(spell_monk_tigereye_brew_stacks);
    register_aura_script(spell_monk_brewing_mana_tea);
    register_aura_script(spell_monk_mana_tea);
    register_spell_script(spell_monk_mana_tea_glyphed);
    register_spell_script(spell_monk_power_strikes);
    new atrigger_script<sat_monk_chi_sphere>("sat_monk_chi_sphere");
    register_spell_script(spell_monk_clash);
    register_spell_script(spell_monk_clash_caster_charge);
    register_creature_script(npc_black_ox_statue);
    register_aura_script(spell_monk_eminence_driver);
    register_aura_script(spell_monk_stance_of_wise_serpent);
    register_aura_script(spell_monk_soothing_mist);
    register_aura_script(spell_monk_soothing_mist_tirgger);
    register_aura_script(spell_monk_soothing_mist_statue);
    register_spell_script(spell_monk_soothing_mist_statue_trigger);
    register_aura_script(spell_monk_renewing_mist);
    register_spell_script(spell_monk_renewing_mist_jump);
    register_aura_script(spell_monk_spinning_crane_kick);
    register_spell_script(spell_monk_spinning_crane_kick_energize_tirgger);
    register_spell_script(spell_monk_spinning_crane_kick_damage);
    register_spell_script(spell_monk_spinning_crane_kick_heal);
    register_spell_script(spell_monk_surging_mist);
    register_spell_script(spell_monk_surging_mist_glyphed);
    register_spell_script(spell_monk_enveloping_mist);
    register_spell_script(spell_monk_thunder_focus_tea_uplift);
    register_spell_script(spell_monk_thunder_focus_tea);
    register_aura_script(spell_monk_dematerialize);
    register_aura_script(spell_monk_glyph_of_fortuitous_spheres);
    register_aura_script(spell_monk_sanctaury_of_the_ox);
    register_aura_script(spell_monk_guard);
    register_spell_script(spell_monk_black_ox_statue_guard_selector);
    register_spell_script(spell_monk_roll);
    register_aura_script(spell_monk_roll_aura);
    register_spell_script(spell_monk_leer_of_the_ox);
    register_aura_script(spell_monk_mastery_gift_of_the_serpent);
    register_spell_script(spell_monk_gift_of_the_serpent_selector);
    register_spell_script(spell_monk_gif_of_the_serpent_summon);
    new atrigger_script<sat_monk_gift_of_the_serpent>("sat_monk_gift_of_the_serpent");
    register_aura_script(spell_monk_dampen_harm);
    register_spell_script(spell_monk_provoke);
    register_spell_script(spell_monk_provoke_effect);
    register_spell_script(spell_monk_life_cocoon);
    register_spell_script(spell_monk_nimble_brew);
    register_spell_script(spell_monk_touch_of_death);
    register_aura_script(spell_monk_healing_elixirs);
    register_aura_script(spell_monk_healing_elixirs_acitve);
    register_spell_script(spell_monk_healing_elixirs_heal);
    register_spell_script(spell_monk_restless_pursuit);
    register_aura_script(spell_monk_mana_tea_dispel);
    register_spell_script(spell_monk_invoke_xuen);
    register_spell_script(spell_monk_xuen_tiger_leap);
    register_spell_script(spell_monk_xuen_provoke);
    register_aura_script(spell_monk_crackling_tiger_lightning);
    register_pet_script(npc_monk_xuen);
    register_aura_script(spell_monk_sparring);
    ...
    register_aura_script(spell_monk_t15_windwalker_2p_bonus);
    register_spell_script(spell_monk_summon_energy_sphere);
    new atrigger_script<sat_monk_energy_sphere>("sat_monk_energy_sphere");
    register_aura_script(spell_monk_t15_brewmaster_2p_bonus);
    register_aura_script(spell_monk_t16_windwalker_2p_bonus);
    register_aura_script(spell_monk_t16_windwalker_4p_bonus);
    register_aura_script(spell_monk_t16_brewmaster_2p_bonus);
    register_aura_script(spell_monk_t16_brewmaster_4p_bonus);
    register_aura_script(spell_monk_t16_mistweaver_2p_bonus);
    register_aura_script(spell_monk_t16_mistweaver_4p_bonus);
    register_aura_script(spell_monk_tiger_strikes);
    register_aura_script(spell_monk_zen_meditation);
    register_aura_script(spell_monk_bear_hug);
    register_aura_script(spell_monk_glyph_of_rapid_rolling);
    register_aura_script(spell_monk_afterlife);
    register_aura_script(spell_monk_glyph_of_breath_of_fire_fix);
    register_aura_script(spell_monk_desperate_measures);
    register_aura_script(spell_monk_avert_harm);
    register_aura_script(spell_monk_weapon_override_driver);
    register_aura_script(spell_monk_glyph_of_jab);
    register_aura_script(spell_monk_touch_of_death_expel_harm_notification_driver);
    register_aura_script(spell_monk_flying_serpent_kick);
    register_spell_script(spell_monk_glyph_of_targeted_expulsion);
    register_spell_script(spell_monk_revival);
    register_spell_script(spell_monk_jab);
    register_spell_script(spell_monk_muscle_memory);
    register_spell_script(spell_monk_dizzying_haze);
    register_spell_script(spell_monk_charging_ox_wave);
    register_spell_script(spell_monk_charging_ox_wave_visual);
