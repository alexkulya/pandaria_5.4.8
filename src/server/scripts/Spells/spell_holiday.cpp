...
enum PX238WinterWondervoltSpellData
{
...
{
    register_aura_script(spell_love_is_in_the_air_romantic_picnic);
    register_spell_script(spell_hallow_end_trick);
    register_spell_script(spell_hallow_end_trick_or_treat);
    register_spell_script(spell_hallow_end_tricky_treat);
    register_spell_script(spell_winter_veil_mistletoe);
    register_spell_script(spell_winter_veil_px_238_winter_wondervolt);
}
