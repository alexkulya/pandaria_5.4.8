...
void AddSC_rogue_spell_scripts()
{
    ...
    register_spell_script(spell_rog_growl);
    new spell_rog_combat_readiness();
    register_aura_script(spell_rog_nerve_strike);
    register_aura_script(spell_rog_nerve_strike_effect);
    register_spell_script(spell_rog_shroud_of_concealment);
    new spell_rog_master_poisoner();
    register_spell_script(spell_rog_slice_and_dice);
    new spell_rog_deadly_poison_instant_damage();
    register_aura_script(spell_rog_paralytic_poison);
    new spell_rog_shiv();
    new spell_rog_poisons();
    new spell_rog_deadly_poison();
    new spell_rog_marked_for_death();
    register_aura_script(spell_rog_smoke_bomb);
    register_spell_script(spell_rog_glyph_of_decoy);
    register_aura_script(spell_rog_killing_spree);
    register_spell_script(spell_rog_killing_spree_target_selector);
    register_spell_script(spell_rog_killing_spree_teleport);
    register_spell_script(spell_rog_ambush);
    register_aura_script(spell_rog_main_gauch);
    register_aura_script(spell_rog_combat_potency);
    register_aura_script(spell_rog_sanguinary_vein);
    register_spell_script(spell_rog_sinister_strike);
    register_aura_script(spell_rog_kidney_shot);
    register_spell_script(spell_rog_crimson_tempest);
    register_aura_script(spell_rog_blade_flurry);
    register_spell_script(spell_rog_blade_flurry_damage);
    register_aura_script(spell_rog_poison_proc);
    register_aura_script(spell_rog_cheat_death);
    register_spell_script(spell_rog_shuriken_toss);
    register_aura_script(spell_rog_shuriken_toss_aura);
    register_aura_script(spell_rog_seal_fate);
    register_spell_script(spell_rog_mutilate);
    register_aura_script(spell_rog_anticipation);
    register_aura_script(spell_rog_honor_among_thieves);
    register_aura_script(spell_rog_cut_to_the_chase);
    register_spell_script(spell_rog_hemorrhage);
    register_spell_script(spell_rog_fan_of_knives);
    register_spell_script(spell_rog_vanish_initial);
    register_spell_script(spell_rog_vanish_trigger);
    register_aura_script(spell_rog_stealth);
    register_aura_script(spell_rog_stealth_subterfuge);
    register_aura_script(spell_rog_vanish);
    register_aura_script(spell_rog_venomous_wounds);
    register_aura_script(spell_rog_rupture);
    register_aura_script(spell_rog_bandits_guile);
    register_aura_script(spell_rog_restless_blades);
    register_spell_script(spell_rog_relentless_strikes);
    register_spell_script(spell_rog_subterfuge_cast_trigger);
    register_spell_script(spell_rog_blind);
    register_spell_script(spell_rog_deadly_throw);
    register_spell_script(spell_rog_redirect);
    register_aura_script(spell_rog_tricks_of_the_trade);
    register_aura_script(spell_rog_tricks_of_the_trade_dummy);
    register_aura_script(spell_rog_leeching_poison);
    register_aura_script(spell_rog_recuperate);
    register_aura_script(spell_rog_shadow_blades);
    register_aura_script(spell_rog_vendetta);
    register_aura_script(spell_rog_assasination_respec);
    register_spell_script(spell_rog_envemon);
    register_spell_script(spell_rog_preparation);
    register_aura_script(spell_rog_glyph_of_deadly_momentum);
    register_spell_script(spell_rog_t15_2p_bonus);
    register_aura_script(spell_rog_t16_2p_bonus);
    register_aura_script(spell_rog_silent_blades);
    register_aura_script(spell_rog_t16_4p_bonus);
    register_spell_script(spell_rog_t16_4p_bonus_killing_spree);
    register_spell_script(spell_rog_glyph_of_gouge);
    register_aura_script(spell_rog_dirty_tricks);
    register_spell_script(spell_rog_glyph_of_recovery_fix);
    register_spell_script(spell_rog_glyph_of_disguise);
    register_spell_script(spell_rog_cloak_and_dagger);
    register_spell_script(spell_rog_glyph_of_kick);
    register_spell_script(spell_rog_distract);
    register_spell_script(spell_rog_duration_check);
    register_spell_script(spell_rog_shadowstep);
}
