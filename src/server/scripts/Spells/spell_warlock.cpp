...
{
    register_aura_script(spell_warl_health_funnel);
    register_spell_script(spell_warl_health_funnel_soulburn);
    new spell_warl_soulburn_seed_of_corruption_damage();
    register_spell_script(spell_warl_soulburn_seed_of_corruption);
    register_aura_script(spell_warl_soulburn_override);
    register_spell_script(spell_soulburn_consumer);
    register_spell_script(spell_warl_curse_of_exhaustion_soulburn);
    new spell_warl_glyph_of_soulwell();
    new spell_warl_glyph_of_imp_swarm();
    register_spell_script(spell_warl_unbound_will);
    new spell_warl_kil_jaedens_cunning();
    new spell_warl_shield_of_shadow();
    register_spell_script(spell_warl_flames_of_xoroth);
    new spell_warl_soul_link();
    register_spell_script(spell_warl_decimate);
    register_spell_script(spell_warl_chaos_wave);
    register_aura_script(spell_warl_dark_bargain_on_absorb);
    register_aura_script(spell_warl_dark_regeneration);
    new spell_warl_sacrificial_pact();
    new spell_warl_twilight_ward_s12();
    register_aura_script(spell_warl_burning_rush);
    register_spell_script(spell_warl_conflagrate_aura);
    register_aura_script(spell_warl_shadowburn);
    register_aura_script(spell_warl_burning_embers);
    new spell_warl_soul_harverst();
    register_spell_script(spell_warl_life_tap);
    register_aura_script(spell_warl_life_tap_heal_absorb);
    register_spell_script(spell_warl_fear);
    new spell_warl_banish();
    new spell_warl_soulshatter();
    register_aura_script(spell_warl_unstable_affliction);
    register_aura_script(spell_warl_backlash);
    register_spell_script(spell_warl_blood_horror);
    register_aura_script(spell_warl_blood_horror_aura);
    new spell_warl_haunt();
    new spell_warl_singe_magic();
    register_aura_script(spell_warl_glyph_of_shadow_bolt);
    register_aura_script(spell_warl_glyph_of_shadow_bolt_spec_fix);
    register_spell_script(spell_warl_shadow_bolt_glyphed);
    register_aura_script(spell_warl_grimoire_of_supremacy);
    register_aura_script(spell_warl_grimoire_of_service_server_side);
    register_aura_script(spell_warl_grimoire_of_sacrifice);
    register_aura_script(spell_warl_grimoire_of_sacrifice_health_fix);
    register_spell_script(spell_warl_grimoire_of_sacrifice_selector);
    register_aura_script(spell_warl_wild_imp);
    register_aura_script(spell_gen_fel_energy);
    register_creature_script(npc_warlock_guardian);
    register_creature_script(npc_wild_imp);
    register_creature_script(npc_grimoire_of_service_pet);
    register_creature_script(npc_doomguard);
    register_creature_script(npc_warl_infernal);
    register_spell_script(spell_warl_summon_doomguard);
    register_spell_script(spell_warl_doombolt);
    register_spell_script(spell_warl_demonic_fury_energize);
    register_spell_script(spell_warl_demonic_fury_visual_controller);
    register_spell_script(spell_warl_hellfire);
    register_aura_script(spell_warl_mastery_master_demonologist);
    register_aura_script(spell_warl_master_demonologist);
    register_aura_script(spell_warl_demonic_fury);
    register_aura_script(spell_warl_metamorphosis);
    register_aura_script(spell_warl_soul_shards);
    register_spell_script(spell_warl_ember_consumer);
    register_spell_script(spell_warl_ember_tap);
    register_aura_script(spell_warl_glyph_of_ember_tap);
    register_spell_script(spell_warl_fire_and_brimstone);
    register_spell_script(spell_warl_fire_and_brimstone_spell);
    register_aura_script(spell_warl_fire_and_brimstone_immolate);
    register_spell_script(spell_warl_always_cirt);
    register_spell_script(spell_warl_imp_swarm);
    register_spell_script(spell_warl_fel_firebolt);
    register_aura_script(spell_warl_shadowflame);
    register_aura_script(spell_warl_molten_core);
    register_aura_script(spell_warl_seed_of_corruption);
    register_spell_script(spell_warl_seed_of_corruption_soulburn_explode);
    register_aura_script(spell_warl_malefic_grasp);
    register_aura_script(spell_warl_drain_soul);
    register_aura_script(spell_warl_agony);
    register_spell_script(spell_warl_agony_instant_tick);
    register_spell_script(spell_warl_soul_swap);
    register_aura_script(spell_warl_soul_swap_aura);
    register_spell_script(spell_warl_soul_swap_exhale);
    register_spell_script(spell_warl_soul_swap_soulburn);
    register_aura_script(spell_warl_dark_apotheosis);
    register_aura_script(spell_warl_metamorphosis_overrides);
    register_aura_script(spell_warl_demonic_calling);
    register_aura_script(spell_warl_glyph_of_demon_hunting);
    register_spell_script(spell_warl_demonic_leap);
    register_spell_script(spell_warl_demonic_leap_jump);
    register_spell_script(spell_warl_healthstone);
    register_aura_script(spell_warl_healthstone_glyphed);
    register_aura_script(spell_warl_demonic_circle_summon);
    register_aura_script(spell_warl_demonic_circle_teleport);
    register_aura_script(spell_warl_backdraft_proc_driver);
    register_aura_script(spell_warl_backdraft);
    register_spell_script(spell_warl_backdraft_consumer);
    register_spell_script(spell_warl_soulstone);
    register_spell_script(spell_warl_soulstone_resurrect);
    register_aura_script(spell_warl_havoc);
    register_spell_script(spell_warl_havoc_target_selector);
    register_aura_script(spell_warl_rain_of_fire);
    register_aura_script(spell_warl_soul_link);
    register_aura_script(spell_warl_soul_leech);
    register_aura_script(spell_warl_override_command_demon);
    register_spell_script(spell_warl_command_demon);
    register_spell_script(spell_warl_command_demon_cooldown);
    register_spell_script(spell_warl_create_healthstone);
    register_spell_script(spell_warl_hand_of_guldan);
    register_spell_script(spell_warl_hand_of_guldan_glyphed);
    register_spell_script(spell_warl_demonic_gateway);
    register_spell_script(spell_warl_demonic_gateway_summon);
    register_aura_script(spell_warl_demonic_gateway_aura);
    register_creature_script(npc_demonic_gateway);
    register_aura_script(spell_warl_drain_life);
    register_aura_script(spell_warl_glyph_of_siphon_life);
    register_spell_script(spell_warl_glyph_of_siphon_life_heal);
    register_aura_script(spell_warl_chaos_bolt_dot);
    register_spell_script(spell_warl_pet_auto_cast);
    register_spell_script(spell_warl_shadow_bulwark);
    register_spell_script(spell_warl_suffering);
    register_spell_script(spell_warl_seduction);
    register_spell_script(spell_warl_shadow_shield);
    register_aura_script(spell_warl_shadow_shield_aura);
    register_spell_script(spell_warl_touch_of_chaos);
    register_aura_script(spell_warl_howl_of_terror_cooldown);
    register_spell_script(spell_warl_legion_strike);
    register_spell_script(spell_warl_devour_magic);
    register_spell_script(spell_warl_devour_magic_heal);
    register_aura_script(spell_warl_glyph_of_demon_training);
    register_spell_script(spell_warl_glyph_of_demon_training_seduction);
    register_spell_script(spell_warl_glyph_of_demon_trainig_firebolt);
    register_spell_script(spell_warl_glyph_of_carrion_swarm);
    register_spell_script(spell_warl_unending_breath_soulburn);
    register_spell_script(spell_warl_soul_shards_visual_test);
    register_spell_script(spell_warl_ember_test);
    register_spell_script(spell_warl_glyph_of_felguard);
    register_spell_script(spell_warl_glyph_of_felguard_loading);
    register_aura_script(spell_warl_glyph_of_verdant_spheres);
    register_aura_script(spell_warl_glyph_of_soul_consumption);
    register_aura_script(spell_warl_archimondes_darkness);
    register_aura_script(spell_warl_t16_2p_bonus);
    register_aura_script(spell_warl_t16_4p_bonus);
    register_aura_script(spell_warl_haunt_t16);
    register_aura_script(spell_warl_fury_ward_fix);
    register_aura_script(spell_warl_twilight_ward_fix);
    register_aura_script(spell_warl_meteor_slam);
    register_aura_script(spell_warl_corruption);
    register_aura_script(spell_warl_nightfall);
}
