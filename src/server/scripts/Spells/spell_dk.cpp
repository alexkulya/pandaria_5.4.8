...
{
    register_spell_script(spell_dk_gorefiends_grasp);
    new spell_dk_runic_empowerment();
    new spell_dk_might_of_ursoc();
    register_aura_script(spell_dk_desecrated_ground);
    register_aura_script(spell_dk_necrotic_strike);
    new spell_dk_festering_strike();
    register_aura_script(spell_dk_remorseless_winter_targets);
    register_spell_script(spell_dk_remorseless_winter);
    register_aura_script(spell_dk_pillar_of_frost);
    register_spell_script(spell_dk_blood_charges);
    register_spell_script(spell_dk_blood_tap);
    register_spell_script(spell_dk_death_strike);
    register_spell_script(spell_dk_death_strike_heal);
    new spell_dk_purgatory();
    new spell_dk_purgatory_absorb();
    new spell_dk_unholy_blight();
    register_spell_script(spell_dk_chilblains);
    register_spell_script(spell_dk_outbreak);
    new spell_dk_anti_magic_shell_raid();
    register_aura_script(spell_dk_anti_magic_shell);
    new spell_dk_anti_magic_zone();
    new spell_dk_ghoul_explode();
    new spell_dk_death_gate();
    new spell_dk_death_pact();
    new spell_dk_scourge_strike();
    register_spell_script(spell_dk_death_grip);
    register_spell_script(spell_dk_death_grip_effect);
    ...
    register_aura_script(spell_dk_death_and_decay);
    register_spell_script(spell_dk_glyph_of_death_and_decay);
    register_spell_script(spell_dk_death_coil);
    register_spell_script(spell_dk_bone_shield_check);
    register_aura_script(spell_dk_bone_shield);
    register_spell_script(spell_dk_plague_leech);
    register_aura_script(spell_dk_sudden_doom);
    register_aura_script(spell_dk_threat_of_tassarian);
    register_aura_script(spell_dk_vampiric_blood);
    register_aura_script(spell_dk_soul_reaper);
    register_spell_script(spell_dk_howling_blast);
    register_aura_script(spell_dk_rune_converter);
    register_spell_script(spell_dk_blood_parasite);
    register_creature_script(npc_bloodworm);
    register_aura_script(spell_dk_shadow_infusion_proc);
    register_aura_script(spell_dk_shadow_infusion);
    register_spell_script(spell_dk_dark_transformation);
    register_spell_script(spell_dk_ghoul_ability);
    register_spell_script(spell_dk_raise_dead);
    register_spell_script(spell_dk_death_siphon);
    register_aura_script(spell_dk_glyph_of_unholy_command);
    register_spell_script(spell_dk_presence);
    register_spell_script(spell_dk_blood_boil);
    register_spell_script(spell_dk_asphyxiate);
    register_spell_script(spell_dk_summon_gargoyle);
    register_creature_script(npc_ebon_gargoyle);
    register_spell_script(spell_dk_gargoyle_strike);
    register_aura_script(spell_dk_relentless_grip);
    register_aura_script(spell_dk_dark_simulacrum);
    register_spell_script(spell_dk_dancing_rune_weapon);
    register_aura_script(spell_dk_dancing_rune_weapon_driver);
    register_aura_script(spell_dk_rune_weapon_scaling);
    register_aura_script(spell_dk_runic_corruption);
    register_aura_script(spell_dk_t15_dps_4p_bonus);
    register_creature_script(npc_dk_fallen_zandaliari);
    register_aura_script(spell_dk_t15_blood_4p_bonus);
    register_spell_script(spel_dk_death_shroud_duration);
    register_aura_script(spell_dk_death_shroud);
    register_aura_script(spell_dk_t16_dps_4p_bonus);
    register_aura_script(spell_dk_t16_blood_2p_bonus);
    register_aura_script(spell_dk_t16_blood_4p_bonus);
    register_spell_script(spell_dk_frozen_power);
    register_spell_script(spell_dk_pestilence);
    register_spell_script(spell_dk_glyph_of_strangulate);
    register_aura_script(spell_dk_will_of_the_necropolis);
    register_spell_script(spell_dk_will_of_the_necropolis_rune_tap);
    register_aura_script(spell_dk_crimson_scourge);
    register_aura_script(spell_dk_wild_mushroom_plague_periodic);
    register_spell_script(spell_dk_wild_mushroom_plague_trigger);
    register_creature_script(npc_dk_army_of_the_dead_ghoul);
    register_aura_script(spell_dk_glyph_of_the_skeleton);
    register_aura_script(spell_dk_glyph_of_regenerative_magic);
    register_aura_script(spell_dk_tricks_of_the_trade_fix);
    register_aura_script(spell_dk_scent_of_blood_main_hand);
    register_spell_script(spell_dk_glyph_of_the_loud_horn);
    new atrigger_script<sat_dk_anti_magic_zone>("sat_dk_anti_magic_zone");
    register_spell_script(spell_dk_death_gate_eff);
    register_aura_script(aura_glyph_of_the_geist);
}
