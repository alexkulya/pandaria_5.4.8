...
void AddSC_shaman_spell_scripts()
{
    ...
    new spell_sha_hex();
    new spell_sha_prowl();
    register_spell_script(spell_sha_glyph_of_shamanistic_rage);
    new spell_sha_glyph_of_lakestrider();
    new spell_sha_mail_specialization();
    new spell_sha_frozen_power();
    register_spell_script(spell_sha_unleash_elements);
    register_spell_script(spell_sha_unleashed_fury_earthliving);
    register_aura_script(spell_sha_unleashed_fury_earthliving_riptide);
    register_aura_script(spell_sha_unleashed_fury_rockbiter);
    register_aura_script(spell_sha_unleash_frost);
    register_spell_script(spell_sha_fulmination);
    register_aura_script(spell_sha_lava_surge);
    register_spell_script(spell_sha_lava_surge_cooldown_fix);
    new spell_sha_elemental_blast();
    new spell_sha_earthquake_tick();
    new spell_sha_earthquake();
    register_spell_script(spell_sha_healing_rain);
    register_aura_script(spell_sha_healing_rain_aura);
    new spell_sha_ascendance();
    new spell_sha_lava_burst();
    new spell_sha_lava_burst_mastery_proc();
    register_aura_script(spell_sha_earthliving_weapon);
    register_aura_script(spell_sha_elemental_oveload);
    register_aura_script(spell_sha_rolling_thunder);
    register_aura_script(spell_sha_glyph_of_telluric_currents);
    register_aura_script(spell_sha_lighting_shield);
    register_aura_script(spell_sha_earth_shield);
    register_aura_script(spell_sha_echo_of_the_elements);
    register_aura_script(spell_sha_water_ascendant);
    register_aura_script(spell_sha_primal_elementalist);
    register_spell_script(spell_sha_restorative_mists);
    register_aura_script(spell_sha_conductivity);
    register_spell_script(spell_sha_chain_heal);
    register_spell_script(spell_sha_earthgrab);
    register_aura_script(spell_sha_tidal_waves);
    register_aura_script(spell_sha_natures_guardian);
    register_aura_script(spell_sha_stone_bulwark);
    register_aura_script(spell_sha_stone_bulwark_totem_passive);
    register_spell_script(spell_sha_hp_based_totem);
    register_spell_script(spell_sha_totemic_projection);
    register_spell_script(spell_sha_spirit_link);
    register_spell_script(spell_sha_elemental_totem_summon);
    register_spell_script(spell_sha_lava_lash);
    register_spell_script(spell_sha_lava_lash_spread_flame_shock);
    register_spell_script(spell_sha_healing_stream);
    register_aura_script(spell_sha_windfury_weapon);
    register_spell_script(spell_sha_call_of_the_elements);
    register_spell_script(spell_sha_fire_nova);
    register_spell_script(spell_sha_glyph_of_purging);
    register_spell_script(spell_sha_stormstrike);
    register_spell_script(spell_sha_static_charge);
    register_aura_script(spell_sha_ancestral_awakening);
    new aura_script_name<spell_sha_ancestral_awakening>("spell_sha_t15_restoration_4p_bonus");
    register_spell_script(spell_sha_ancestral_awakening_selector);
    register_spell_script(spell_sha_searing_flames_summon);
    register_aura_script(spell_sha_searing_flames_proc_aura);
    register_aura_script(spell_sha_ancestral_guidance);
    register_spell_script(spell_sha_acestral_guidance_heal);
    register_aura_script(spell_sha_purification);
    register_aura_script(spell_sha_static_shock);
    register_aura_script(spell_sha_enchanced_elements);
    register_aura_script(spell_sha_elemental_totem);
    register_aura_script(spell_sha_flametongue_weapon);
    register_aura_script(spell_sha_resurgence);
    register_aura_script(spell_sha_glyph_of_flame_shock);
    register_spell_script(spell_sha_spiritwalkers_grace);
    register_aura_script(spell_sha_grounding_totem_effect);
    register_creature_script(npc_sha_spirit_wolf);
    register_aura_script(spell_sha_spirit_hunt);
    register_aura_script(spell_sha_stormlash_totem);
    register_spell_script(spell_sha_glyph_of_cleansing_waters);
    register_spell_script(spell_sha_maelstrom_weapon_haste_fix);
    register_spell_script(spell_sha_t15_enhancement_2p_bonus);
    register_spell_script(spell_sha_lightning_strike);
    register_aura_script(spell_sha_flow_elements);
    register_spell_script(spell_sha_t15_elemental_4p_bonus);
    register_aura_script(spell_sha_t16_enchancement_4p_bonus);
    register_spell_script(spell_sha_t16_restoration_2p_bonus);
    register_creature_script(npc_sha_spiritwalker_champion);
    register_aura_script(spell_sha_t16_restoration_4p_heal_trigger);
    register_spell_script(spell_sha_t16_restoration_4p_selector);
    register_aura_script(spell_sha_t16_elemental_2p_bonus);
    register_creature_script(npc_sha_lightning_elemental);
    register_creature_script(npc_sha_earth_elemental);
    register_creature_script(npc_sha_fire_elemental);
    register_aura_script(spell_sha_glyph_of_healing_wave);
    register_aura_script(spell_sha_maelstrom_weapon_visual);
    register_spell_script(spell_sha_glyph_of_thunder);
    register_aura_script(spell_sha_mana_tide);
    register_aura_script(spell_sha_clearcasting);
    register_aura_script(spell_sha_glyph_of_totemic_encirclement);
    register_aura_script(spell_sha_glyph_of_eternal_earth);
    register_spell_script(spell_sha_glyph_of_spirit_wolf);
    register_spell_script(spell_sha_summon_elemental_familiar);
    register_spell_script(spell_sha_elemental_familiar_selector);
}
