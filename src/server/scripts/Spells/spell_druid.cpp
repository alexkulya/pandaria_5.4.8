...
{
    register_aura_script(spell_dru_tooth_and_claw_absorb);
    register_spell_script(spell_dru_tooth_and_claw_trigger);
    register_spell_script(spell_dru_swipe_and_maul_bleed);
    register_spell_script(spell_dru_genesis);
    new spell_dru_glyph_of_the_treant();
    new spell_dru_incarnation_chosen_of_elune();
    register_aura_script(spell_dru_incarnation_skins);
    ...
    register_spell_script(spell_dru_demonic_circle_teleport);
    register_spell_script(spell_dru_shattering_blow);
    new spell_dru_moonfire();
    register_aura_script(spell_dru_natures_vigil);
    register_spell_script(spell_dru_natures_vigil_damage);
    register_spell_script(spell_dru_natures_vigil_heal);
    new spell_dru_cenarion_ward();
    new atrigger_script<sat_druid_solar_beam>("sat_druid_solar_beam");
    new spell_dru_dash();
    register_spell_script(spell_dru_rip_duration);
    register_spell_script(spell_dru_savage_defense);
    new spell_dru_bear_hug();
    new spell_dru_ravage();
    new spell_dru_mark_of_the_wild();
    new spell_dru_glyph_of_regrowth();
    register_aura_script(spell_dru_cat_form);
    new spell_dru_skull_bash();
    register_spell_script(spell_dru_faerie_swarm);
    register_aura_script(spell_dru_astral_communion);
    new spell_dru_shooting_stars();
    register_spell_script(spell_dru_celestial_alignment);
    register_spell_script(spell_dru_frenzied_regeneration);
    new spell_dru_stampeding_roar_speed();
    register_spell_script(spell_dru_stampeding_roar);
    register_aura_script(spell_dru_innervate);
    register_spell_script(spell_dru_glyph_of_innervate);
    register_spell_script(spell_dru_teleport_moonglade);
    register_spell_script(spell_dru_growl);
    register_spell_script(spell_dru_activate_cat_form);
    register_spell_script(spell_dru_eclipse);
    register_spell_script(spell_dru_eclipse_energize);
    register_spell_script(spell_dru_eclipse_solar);
    register_spell_script(spell_dru_eclipse_lunar);
    register_spell_script(spell_dru_glyph_of_omens);
    register_aura_script(spell_dru_eclipse_remove);
    register_aura_script(spell_dru_eclipse_effect);
    new spell_dru_t10_restoration_4p_bonus();
    new spell_dru_swift_flight_passive();
    register_aura_script(spell_dru_savage_roar);
    register_spell_script(spell_dru_savage_roar_duration_check);
    new spell_dru_survival_instincts();
    new spell_dru_yseras_gift();
    new spell_dru_yseras_gift_heal_ally();
    register_aura_script(spell_dru_t15_restoration_4p_bonus);
    register_spell_script(spell_dru_swiftmend);
    register_aura_script(spell_dru_efflorescence);
    register_spell_script(spell_dru_efflorescence_heal);
    register_spell_script(spell_dru_faerie_fire);
    register_spell_script(spell_dru_lacerate);
    register_aura_script(spell_dru_primal_fury);
    register_spell_script(spell_dru_ferocious_bite);
    register_aura_script(spell_dru_harmony);
    register_spell_script(spell_dru_tree_of_life);
    register_spell_script(spell_dru_wild_growth);
    register_aura_script(spell_dru_wild_growth_heal);
    register_spell_script(spell_dru_healing_touch_dream_of_cenarius);
    register_spell_script(spell_dru_wrath_dream_of_cenarius);
    register_aura_script(spell_dur_dream_of_cenarius);
    register_spell_script(spell_dru_wild_mushroom);
    register_spell_script(spell_dru_wild_mushroom_detonate);
    register_spell_script(spell_dru_wild_mushroom_bloom);
    register_spell_script(spell_dru_wild_mushroom_heal);
    register_aura_script(spell_dru_wild_mushroom_overheal);
    register_creature_script(npc_wild_mushroom);
    register_creature_script(npc_fungal_growth);
    register_aura_script(spell_dru_lifebloom);
    register_spell_script(spell_dru_lifebloom_refresh);
    register_spell_script(spell_dru_swipe);
    new atrigger_script<sat_druid_ursols_vortex>("sat_druid_ursols_vortex");
    register_aura_script(spell_dru_heart_of_the_wild);
    register_aura_script(spell_dru_heart_of_the_wild_bonus);
    register_spell_script(spell_dru_savage_roar_glyphed);
    register_aura_script(spell_dru_living_seed);
    register_aura_script(spell_dru_living_seed_heal);
    register_aura_script(spell_dru_starfall);
    register_spell_script(spell_dru_starfall_damage);
    register_spell_script(spell_dru_thrash_bear);
    register_aura_script(spell_dru_shooting_stars_trigger);
    register_aura_script(spell_dru_shooting_stars_proc);
    register_aura_script(spell_dru_soul_of_the_forest);
    register_spell_script(spell_dru_soul_of_the_forest_mangle);
    register_spell_script(spell_dru_soul_of_the_forest_feral);
    register_spell_script(spell_dru_shred);
    register_aura_script(spell_dru_item_pvp_feral_4p);
    register_aura_script(spell_dru_stampede_effect);
    register_aura_script(spell_dru_stampede_timer);
    register_aura_script(spell_dru_override_ravage);
    register_aura_script(spell_dru_leader_of_the_pack);
    register_aura_script(spell_dru_bear_form);
    register_spell_script(spell_dru_force_of_nature_balance);
    register_spell_script(spell_dru_force_of_nature_restoration);
    register_spell_script(spell_dru_force_of_nature_feral);
    register_spell_script(spell_dru_force_of_nature_guradian);
    register_creature_script(npc_force_of_nature_balance);
    register_creature_script(npc_force_of_nature_restoration);
    register_aura_script(spell_dru_force_of_nature_rake);
    register_spell_script(spell_dru_cat_form_check);
    register_aura_script(spell_dru_travel_form);
    register_spell_script(spell_dru_glyph_of_fae_silence);
    register_aura_script(spell_dru_bear_form_passive);
    register_aura_script(spell_dru_glyph_of_fae_silence_cooldown);
    register_aura_script(spell_dru_t15_guardian_4p_bonus);
    register_aura_script(spell_dru_t16_guardian_2p_bonus);
    register_spell_script(spell_dur_t16_guardian_4p_bonus);
    register_spell_script(spell_dru_t16_feral_2p_bonus);
    register_aura_script(spell_dru_t16_feral_4p_bonus);
    register_aura_script(spell_dru_feral_rage);
    register_aura_script(spell_dru_t16_balance_2p_bonus);
    register_aura_script(spell_dru_sage_mender);
    register_aura_script(spell_dru_vengeance);
    register_aura_script(spell_dru_glyph_of_rejuvenation);
    register_aura_script(spell_dru_glyph_of_healing_touch);
    register_aura_script(spell_dru_symbiosis_caster_aura);
    register_aura_script(spell_dru_symbiosis_target_check);
    register_spell_script(spell_dru_symbiosis);
    register_aura_script(spell_dru_symbiosis_fortifying_brew);
    register_aura_script(spell_dru_killer_instinct);
    register_aura_script(spell_dru_sudden_eclipse);
    register_aura_script(spell_dru_prowl);
    register_aura_script(spell_dru_glyph_of_hurricane);
    register_aura_script(spell_dru_shapeshift_move_speed);
    register_aura_script(spell_dru_berserk_bear);
    register_aura_script(spell_dru_glyph_of_the_predator);
    register_aura_script(spell_dru_glyph_of_the_chameleon_fix);
    register_aura_script(spell_dru_glyph_of_the_chameleon);
    register_spell_script(spell_dru_intimidating_roar);
}
