...
public:
    ...
    struct boss_patchwerkAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            if (instance)
                instance->DoStopTimedAchievement(CRITERIA_START_TYPE_EVENT, ACHIEV_MAKE_QUICK_WERK_OF_HIM_STARTING_EVENT);
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            if (instance)
                instance->DoStartCriteria(CRITERIA_START_TYPE_EVENT, ACHIEV_MAKE_QUICK_WERK_OF_HIM_STARTING_EVENT);
        }
