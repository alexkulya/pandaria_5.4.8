    ...
    public:
        ...
        struct boss_sapphironAI : public BossAI
        {
            ...
            void InitializeAI() override
            {
                ...
                me->SummonGameObject(GO_BIRTH, x, y, z, 0, { }, 0);
                me->SetVisible(false);
            ...
            void SpellHitTarget(Unit* target, SpellInfo const* spell) override
            {
                if (spell->Id == SPELL_ICEBOLT)
                {
                    ...
                    {
                        if (GameObject* iceblock = me->SummonGameObject(GO_ICEBLOCK, target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(), 0, { }, 25000))
