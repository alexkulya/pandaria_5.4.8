        ...
        struct npc_tirion_tocAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 uiDiff) override
            {
                ...
                if (_updateTimer <= uiDiff)
                {
                    ...
                    {
                        case 110:
                            me->HandleEmoteStateCommand(EMOTE_ONESHOT_TALK);
                            Talk(SAY_STAGE_0_01);
                        ...
                        case 6000:
                            ...
                            me->SummonGameObject(GO_PORTAL_TO_DALARAN, EndSpawnLoc[2].GetPositionX(), EndSpawnLoc[2].GetPositionY(), EndSpawnLoc[2].GetPositionZ(), 5, { }, 0);
                            _updateTimer = 20*IN_MILLISECONDS;
