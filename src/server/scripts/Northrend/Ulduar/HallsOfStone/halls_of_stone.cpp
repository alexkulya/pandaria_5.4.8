    ...
    struct npc_brann_hosAI : public npc_escortAI
    {
        ...
        void Reset() override
        {
            if (!HasEscortState(STATE_ESCORT_ESCORTING))
            {
                ...
                me->GetMap()->SetWorldState(WORLDSTATE_BRANN_SPANKIN_NEW, 1);
            }
        }
        ...
        {
            if (me->GetMap()->GetWorldState(WORLDSTATE_BRANN_SPANKIN_NEW))
                me->GetMap()->SetWorldState(WORLDSTATE_BRANN_SPANKIN_NEW, 0);
        }
