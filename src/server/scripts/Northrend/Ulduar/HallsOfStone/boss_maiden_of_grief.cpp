    ...
    struct boss_maiden_of_griefAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            if (instance)
            {
                ...
                instance->DoStopTimedAchievement(CRITERIA_START_TYPE_EVENT, ACHIEV_GOOD_GRIEF_START_EVENT);
            }
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            if (instance)
            {
                ...
                instance->DoStartCriteria(CRITERIA_START_TYPE_EVENT, ACHIEV_GOOD_GRIEF_START_EVENT);
            }
        }
