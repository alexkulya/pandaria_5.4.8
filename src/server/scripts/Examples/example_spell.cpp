...
class spell_ex : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_AuraScript : public AuraScript
        {
            ...
            //void spell_ex_SpellScript::Function(AuraEffect const* aurEff, float& amount, bool& canBeRecalculated) //DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_ex_SpellScript::Function, EFFECT_ANY, SPELL_AURA_ANY);
