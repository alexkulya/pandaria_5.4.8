...
class spell_blackheart_incite_chaos : public SpellScript
{
    ...
    {
        OnEffectHitTarget += SpellEffectFn(spell_blackheart_incite_chaos::HandleEffectHitTarget, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_blackheart_incite_chaos::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
    }
};
