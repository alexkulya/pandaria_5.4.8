...
#ifndef SF_BATTLEGROUNDAV_H
#define SF_BATTLEGROUNDAV_H

#include "Battleground.h"

#define LANG_BG_AV_A_CAPTAIN_BUFF       0
#define LANG_BG_AV_H_CAPTAIN_BUFF       2
#define LANG_BG_AV_S_MINE_BOSS_CLAIMS   0
...
enum BG_AV_CreatureIds
{
    ...
    AV_NPC_A_GRAVEDEFENSE  = 1,     // stormpike Defender
    ...
    AV_NPC_H_GRAVEDEFENSE  = 8,     // frostwolf guardian
...
BGAVCreauterInfo const BG_AV_CreatureInfo[AV_NPC_INFO_MAX] =
{
    { 12050, 1216, 58, 58 }, //Stormpike Defender
    { 12050, 1216, 59, 59 }, //Stormpike Defender
    ...
    { 12053, 1214, 59, 59 }, //Frostwolf Guardian
...
BGAVCreauterInfo const BG_AV_StaticCreatureInfo[51] =
{
    ...
    { 11947, 1214, 60, 60 }, // Captain Galvangar /// @todo: Duplicate ? Check and confirm
    { 11948, 1216, 61, 61 }, //Vanndar Stormpike
    { 11949, 1216, 60, 60 }, //Captain Balinda Stonehearth
    ...
    { 11946, 1214, 61, 61 }, //Drek'Thar /// @todo: Correct the level (Level 80 for boss ?)
    { 11948, 1216, 61, 61 }, //Vanndar Stormpike
    { 11947, 1214, 60, 60 }, //Captain Galvangar
    { 11949, 1216, 60, 60 }, //Captain Balinda Stonehearth
};
...
struct BattlegroundAVScore : public BattlegroundScore
{
    ...
    uint32 LeadersKilled = 0;
    uint32 SecondaryObjectives = 0;
};

class BattlegroundAV : public Battleground
{
    Position const m_doorAlliance{ 780.487f, -493.024f, 99.9553f, 3.0976f };
    Position const m_doorHorde{ -1375.193f, -538.981f, 55.2824f, 0.72178f };
    ...
    private:
        ...
        char const* GetNodeName(BG_AV_Nodes node, WorldSession* session);
        ...
        void SendAVLocalisedString(uint32 textCase, BG_AV_Nodes node, uint8 mine, uint32 owner);
