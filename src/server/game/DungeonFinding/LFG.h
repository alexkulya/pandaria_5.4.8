...
enum
{
    QUEST_LFG_SHORTAGE = 32097,
    QUEST_LFR_SHORTAGE = 33233,
};
...
enum LfgLockStatusType
{
    ...
    LFG_LOCKSTATUS_INCOMPATIBLE_FACTION          = 10,
...
{
    LFG_CATEGORY_NONE                            = 0,
    LFG_CATEGORY_DUNGEON                         = 1,
    LFG_CATEGORY_LFR                             = 2,
    LFG_CATEGORY_SCENARIO                        = 3,
    LFG_CATEGORY_FLEX                            = 4,
};
