...
{
    PLAYER_DYNAMIC_UNK_0                        = 0x0, // maybe special spell ids (visual glyphs, 20113 or 57979)
    PLAYER_DYNAMIC_UNK_1                        = 0x1,
    PLAYER_DYNAMIC_FIELD_RESERACH_SITE          = 0x2, // 20 fields, 4 per map
    PLAYER_DYNAMIC_FIELD_RESEARCH_SITE_PROGRESS = 0x3,
    PLAYER_DYNAMIC_FIELD_DAILY_QUESTS           = 0x4,
