...
protected:
    ...
    void InitLinear(Vector3 const*, index_type, float, bool, index_type);
    void InitCatmullRom(Vector3 const*, index_type, float, bool, index_type);
    void InitBezier3(Vector3 const*, index_type, float, bool, index_type);
    typedef void (SplineBase::*InitMethtod)(Vector3 const*, index_type, float, bool, index_type);
...
public:
    ...
    void init_spline(Vector3 const* controls, index_type count, float initialOrientation, EvaluationMode m);
    void init_cyclic_spline(Vector3 const* controls, index_type count, float initialOrientation, EvaluationMode m, index_type cyclic_point);
...
public:
    ...
    /** Initializes spline. Don't call other methods while spline not initialized. */
    void init_spline(Vector3 const* controls, index_type count, float initialOrientation, EvaluationMode m) { SplineBase::init_spline(controls, count, initialOrientation, m); }
    void init_cyclic_spline(Vector3 const* controls, index_type count, float initialOrientation, EvaluationMode m, index_type cyclic_point) { SplineBase::init_cyclic_spline(controls, count, initialOrientation, m, cyclic_point); }
