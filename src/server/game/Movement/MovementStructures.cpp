...
MovementStatusElements const MovementSetIgnoreMovementForceAck[] = // 5.4.8 18414 (placeholder)
{
    MSEEnd,
};
...
{
    MSEMountDisplayIdWithoutCheck, // 196
    MSEPositionZ,              // 52  34h
    MSEExtraElement,           // 16  10h
    MSEPositionY,              // 48  30h
    MSECount,                  // 184
...
MovementStatusElements const MovementUpdatePitchBack[] = // 5.4.8 18414
{
    MSEHasGuidByte7,           // 23
    MSEHasMovementFlags,       // 24
    MSEHasSplineElevation,     // 144 90h
...
{
    MSEExtraElement,           // 176 byte
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEExtraElement,           // 186 2
    MSEExtraElement,           // 185 1
    MSEHasTimestamp,           // 32
    MSEHasGuidByte6,           // 22
    MSEHasGuidByte0,           // 16
    MSEHasGuidByte2,           // 18
    MSEExtraElement,           // 191 7
    MSEHasGuidByte7,           // 23
    MSEHasGuidByte1,           // 17
    MSEExtraElement,           // 189 5
    MSEExtraElement,           // 187 3
    MSEHasTransportData,       // 104
    MSEHasMovementFlags2,      // 28
    MSEExtraElement,           // 190 6
    MSEExtraElement,           // 188 4
    MSEHasGuidByte4,           // 20
    MSEForcesCount,            // 152
    MSEExtraElement,           // 184 0
    MSEHasOrientation,         // 48
    MSEHasGuidByte5,           // 21
    MSEZeroBit,                // 172
    MSEZeroBit,                // 148
...
MovementStatusElements const MovementGravityDisable[] =  // 5.4.8 18414
{
    MSEHasGuidByte6,
    MSEHasGuidByte1,
    MSEHasGuidByte3,
...
MovementStatusElements const MovementGravityEnable[] =  // 5.4.8 18414
{
    MSEHasGuidByte3,
    MSEHasGuidByte0,
    MSEHasGuidByte7,
...
MovementStatusElements const SetVehicleRecIdAck[] =  // 5.4.8 18414
{
    MSEPositionY,              // 48  30h
    MSECount,                  // 16 (unk)
    MSEPositionX,              // 44  2ch
...
MovementStatusElements const* GetMovementStatusElementsSequence(Opcodes opcode)
{
    switch (opcode)
    {
        ...
        //    return MovementSetIgnoreMovementForceAck;
