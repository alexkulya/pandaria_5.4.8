...
public:
    ...
    struct boss_houndmaster_braunAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            events.ScheduleEvent(EVENT_PIERCING_THROW, 12000);
            events.ScheduleEvent(EVENT_DEATH_BLOSSOM, 18000);
            _EnterCombat();
        }
...
public:
    ...
    struct npc_obedient_houndAI : public ScriptedAI
    {
        ...
        {
            if (action == 1)
                events.ScheduleEvent(EVENT_DOGS_RAGE, 1000);
            ...
            if (action == 2)
            {
                ...
                events.ScheduleEvent(EVENT_DOGS_ATTACK, 0);
            }
        }
