...
#define ERROR_INST_DATA(a)          TC_LOG_ERROR("server", "Instance Data for Karazhan not set properly. Encounter for Creature Entry %u may not work properly.", a->GetEntry());
#endif
