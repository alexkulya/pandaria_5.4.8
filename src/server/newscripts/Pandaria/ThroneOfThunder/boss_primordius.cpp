...
public:
    ...
    struct boss_primordiusAI : public BossAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_MALFORMED_BLOOD, 8000);
            events.ScheduleEvent(EVENT_PRIMORDIAL_STRIKE, 16000);
        ...
        void SetData(uint32 type, uint32 data)
        {
            ...
            case DATA_MUTATE:
                ...
                case SPELL_VOLATILE_PATHOGEN_DUMMY:
                    events.ScheduleEvent(EVENT_VOLATILE_PATHOGEN, 27000);
                    break;
                case SPELL_GAS_BLADDER_DUMMY:
                    events.ScheduleEvent(EVENT_CAUSTIC_GAS, 14000);
                    break;
                }
                break;
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MALFORMED_BLOOD:
                    ...
                    events.ScheduleEvent(EVENT_MALFORMED_BLOOD, 12000);
                    break;
                case EVENT_PRIMORDIAL_STRIKE:
                    ...
                    events.ScheduleEvent(EVENT_PRIMORDIAL_STRIKE, 24000);
                    break;
                //Mutation events
...
public:
    ...
    struct npc_living_fluidAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            events.ScheduleEvent(EVENT_MOVE_TO_PRIMORDIUS, 1000);
        }
        ...
        void DamageTaken(Unit* attacker, uint32 &damage)
        {
            if (damage >= me->GetHealth() && !done)
            {
                ...
                if (mod == 9)
                {
                    ...
                    events.ScheduleEvent(EVENT_MOVE_TO_PRIMORDIUS_VOLATILE, 500);
                }
                else
                {
                    if (Creature* atcasterstalker = me->GetCreature(*me, pInstance->GetData64(NPC_AT_CASTER_STALKER)))
                ...
                case EVENT_MOVE_TO_PRIMORDIUS_VOLATILE:
                    if (Creature* primordius = me->FindNearestCreature(NPC_PRIMORDIUS, 100.0f, true))
                    {
                        ...
                        else
                        {
                            ...
                            events.ScheduleEvent(EVENT_MOVE_TO_PRIMORDIUS_VOLATILE, 1000);
                        }
                    }
                    break;
                }
    ...
    class spell_primordius_evolution_SpellScript : public SpellScript
    {
        ...
        void HandleAfterCast()
        {
            if (GetCaster() && GetCaster()->ToCreature())
            {
                ...
                GetCaster()->ToCreature()->AI()->Talk(SAY_EVOLUTION, 0);
            }
        }
