...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_GUILD_MEMBER, "INSERT INTO guild_member (guildid, guid, `rank`, pnote, offnote, achievement_points, activity, weekActivity) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
